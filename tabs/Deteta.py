...
class pyarchinit_Deteta(QDialog, MAIN_DIALOG_CLASS):
    ...
    if L =='it':
        ...
        CONVERSION_DICT = {
            ...
            "Id endocranial sutures": "Id_endo",
            "Is endocranial sutures": "Is_endo",
            "IId endocranial sutures": "IId_endo",
            "IIs endocranial sutures": "IIs_endo",
            "IIId endocranial sutures": "IIId_endo",
            "IIIs endocranial sutures": "IIIs_endo",
            "IV endocranial sutures": "IV_endo",
            "V endocranial sutures": "V_endo",
            "VI endocranial sutures": "VI_endo",
            "VII endocranial sutures": "VII_endo",
            "VIIId endocranial sutures": "VIIId_endo",
            "VIIIs endocranial sutures": "VIIIs_endo",
            "IXd endocranial sutures": "IXd_endo",
            "IXs endocranial sutures": "IXs_endo",
            "Xd endocranial sutures": "Xd_endo",
            "Xs endocranial sutures": "Xs_endo",
            "Range endocranial sutures min": "endo_min",
            "Range endocranial sutures max": "endo_max",
            ...
            "Range sutures antero lateral min": "ant_lat_min",
            "Range sutures antero lateral max": "ant_lat_max",
            "Range sutures ectocranial min": "ecto_min",
            "Range sutures ectocranial max": "ecto_max"
        }
        SORT_ITEMS = [
            ID_TABLE,
            "Site",
            ...
            "Id endocranial sutures",
            "Is endocranial sutures",
            "IId endocranial sutures",
            "IIs endocranial sutures",
            "IIId endocranial sutures",
            "IIIs endocranial sutures",
            "IV endocranial sutures",
            "V endocranial sutures",
            "VI endocranial sutures",
            "VII endocranial sutures",
            "VIIId endocranial sutures",
            "VIIIs endocranial sutures",
            "IXd endocranial sutures",
            "IXs endocranial sutures",
            "Xd endocranial sutures",
            "Xs endocranial sutures",
            "Range endocranial sutures min",
            "Range endocranial sutures max",
            "Sutures vault 1",
            "Sutures vault 2",
            "Sutures vault 3",
            "Sutures vault 4",
            ...
            "Range sutures antero lateral min",
            "Range sutures antero lateral max",
            "Range sutures ectocranial min",
            "Range sutures ectocranial max"
        ]
    elif L == 'es':
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "Sitio": "sito",
            "N. individuo": "nr_individuo",
            "Rango sinfisis min": "sinf_min",
            "Rango sinfisis max": "sinf_max",
            "Rango sinfisis min 2": "sinf_min_2",
            "Rango sinfisis max 2": "sinf_max_2",
            "SSPIA edad": "SSPIA",
            "SSPIB edad": "SSPIB",
            "SSPIC edad": "SSPIC",
            "SSPID edad": "SSPID",
            "Rango superficie auricular min": "sup_aur_min",
            "Rango superficie auricular max": "sup_aur_max",
            "Rango superficie auricular min 2": "sup_aur_min_2",
            "Rango superficie auricular max 2": "sup_aur_max_2",
            "Rango maxilar superior min": "ms_sup_min",
            "Rango maxilar superior max": "ms_sup_max",
            "Rango maxilar inferior min": "ms_inf_min",
            "Rango maxilar inferior max": "ms_inf_max",
            "Rango desgaste dental min": "usura_min",
            "Rango desgaste dental max": "usura_max",
            "Id suturas endocraneales": "Id_endo",
            "Is suturas endocraneales": "Is_endo",
            "IId suturas endocraneales": "IId_endo",
            "IIs suturas endocraneales": "IIs_endo",
            "IIId suturas endocraneales": "IIId_endo",
            "IIIs suturas endocraneales": "IIIs_endo",
            "IV suturas endocraneales": "IV_endo",
            "V suturas endocraneales": "V_endo",
            "VI suturas endocraneales": "VI_endo",
            "VII suturas endocraneales": "VII_endo",
            "VIIId suturas endocraneales": "VIIId_endo",
            "VIIIs suturas endocraneales": "VIIIs_endo",
            "IXd suturas endocraneales": "IXd_endo",
            "IXs suturas endocraneales": "IXs_endo",
            "Xd suturas endocraneales": "Xd_endo",
            "Xs suturas endocraneales": "Xs_endo",
            "Rango suturas endocraneales min": "endo_min",
            "Rango suturas endocraneales max": "endo_max",
            "Suturas bóveda 1": "volta_1",
            "Suturas bóveda 2": "volta_2",
            "Suturas bóveda 3": "volta_3",
            "Suturas bóveda 4": "volta_4",
            "Suturas bóveda 5": "volta_5",
            "Suturas bóveda 6": "volta_6",
            "Suturas bóveda 7": "volta_7",
            "Suturas antero laterales 6": "lat_6",
            "Suturas antero laterales 7": "lat_7",
            "Suturas antero laterales 8": "lat_8",
            "Suturas antero laterales 9": "lat_9",
            "Suturas antero laterales 10": "lat_10",
            "Rango suturas bóveda min": "volta_min",
            "Rango suturas bóveda max": "volta_max",
            "Rango suturas antero laterales min": "ant_lat_min",
            "Rango suturas antero laterales max": "ant_lat_max",
            "Rango suturas ectocraneales min": "ecto_min",
            "Rango suturas ectocraneales max": "ecto_max"
        }
        SORT_ITEMS = [
            ID_TABLE,
            "Sitio",
            ...
            "Rango sinfisis min",
            "Rango sinfisis max",
            "Rango sinfisis min 2",
            "Rango sinfisis max 2",
            "SSPIA edad",
            "SSPIB edad",
            "SSPIC edad",
            "SSPID edad",
            "Rango superficie auricular min",
            "Rango superficie auricular max",
            "Rango superficie auricular min 2",
            "Rango superficie auricular max 2",
            "Rango maxilar superior min",
            "Rango maxilar superior max",
            "Rango maxilar inferior min",
            "Rango maxilar inferior max",
            "Rango desgaste dental min",
            "Rango desgaste dental max",
            "Id suturas endocraneales",
            "Is suturas endocraneales",
            "IId suturas endocraneales",
            "IIs suturas endocraneales",
            "IIId suturas endocraneales",
            "IIIs suturas endocraneales",
            "IV suturas endocraneales",
            "V suturas endocraneales",
            "VI suturas endocraneales",
            "VII suturas endocraneales",
            "VIIId suturas endocraneales",
            "VIIIs suturas endocraneales",
            "IXd suturas endocraneales",
            "IXs suturas endocraneales",
            "Xd suturas endocraneales",
            "Xs suturas endocraneales",
            "Rango suturas endocraneales min",
            "Rango suturas endocraneales max",
            "Suturas bóveda 1",
            "Suturas bóveda 2",
            "Suturas bóveda 3",
            "Suturas bóveda 4",
            ...
            "Suturas bóveda 6",
            "Suturas bóveda 7",
            "Suturas antero laterales 6",
            "Suturas antero laterales 7",
            "Suturas antero laterales 8",
            "Suturas antero laterales 9",
            "Suturas antero laterales 10",
            "Rango suturas bóveda min",
            "Rango suturas bóveda max",
            "Rango suturas antero laterales min",
            "Rango suturas antero laterales max",
            "Rango suturas ectocraneales min",
            "Rango suturas ectocraneales max"
        ]
    elif L == 'fr':
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "Site": "sito",
            "N. individu": "nr_individuo",
            "Plage symphyse min": "sinf_min",
            "Plage symphyse max": "sinf_max",
            "Plage symphyse min 2": "sinf_min_2",
            "Plage symphyse max 2": "sinf_max_2",
            "SSPIA âge": "SSPIA",
            "SSPIB âge": "SSPIB",
            "SSPIC âge": "SSPIC",
            "SSPID âge": "SSPID",
            "Plage surface auriculaire min": "sup_aur_min",
            "Plage surface auriculaire max": "sup_aur_max",
            "Plage surface auriculaire min 2": "sup_aur_min_2",
            "Plage surface auriculaire max 2": "sup_aur_max_2",
            "Plage maxillaire supérieur min": "ms_sup_min",
            "Plage maxillaire supérieur max": "ms_sup_max",
            "Plage maxillaire inférieur min": "ms_inf_min",
            "Plage maxillaire inférieur max": "ms_inf_max",
            "Plage usure dentaire min": "usura_min",
            "Plage usure dentaire max": "usura_max",
            "Id sutures endocrâniennes": "Id_endo",
            "Is sutures endocrâniennes": "Is_endo",
            "IId sutures endocrâniennes": "IId_endo",
            "IIs sutures endocrâniennes": "IIs_endo",
            "IIId sutures endocrâniennes": "IIId_endo",
            "IIIs sutures endocrâniennes": "IIIs_endo",
            "IV sutures endocrâniennes": "IV_endo",
            "V sutures endocrâniennes": "V_endo",
            "VI sutures endocrâniennes": "VI_endo",
            "VII sutures endocrâniennes": "VII_endo",
            "VIIId sutures endocrâniennes": "VIIId_endo",
            "VIIIs sutures endocrâniennes": "VIIIs_endo",
            "IXd sutures endocrâniennes": "IXd_endo",
            "IXs sutures endocrâniennes": "IXs_endo",
            "Xd sutures endocrâniennes": "Xd_endo",
            "Xs sutures endocrâniennes": "Xs_endo",
            "Plage sutures endocrâniennes min": "endo_min",
            "Plage sutures endocrâniennes max": "endo_max",
            "Sutures voûte 1": "volta_1",
            "Sutures voûte 2": "volta_2",
            "Sutures voûte 3": "volta_3",
            "Sutures voûte 4": "volta_4",
            "Sutures voûte 5": "volta_5",
            "Sutures voûte 6": "volta_6",
            "Sutures voûte 7": "volta_7",
            "Sutures antéro latérales 6": "lat_6",
            "Sutures antéro latérales 7": "lat_7",
            "Sutures antéro latérales 8": "lat_8",
            "Sutures antéro latérales 9": "lat_9",
            "Sutures antéro latérales 10": "lat_10",
            "Plage sutures voûte min": "volta_min",
            "Plage sutures voûte max": "volta_max",
            "Plage sutures antéro latérales min": "ant_lat_min",
            "Plage sutures antéro latérales max": "ant_lat_max",
            "Plage sutures ectocrâniennes min": "ecto_min",
            "Plage sutures ectocrâniennes max": "ecto_max"
        }
        SORT_ITEMS = [
            ID_TABLE,
            "Site",
            ...
            "Plage symphyse min",
            "Plage symphyse max",
            "Plage symphyse min 2",
            "Plage symphyse max 2",
            "SSPIA âge",
            "SSPIB âge",
            "SSPIC âge",
            "SSPID âge",
            "Plage surface auriculaire min",
            "Plage surface auriculaire max",
            "Plage surface auriculaire min 2",
            "Plage surface auriculaire max 2",
            "Plage maxillaire supérieur min",
            "Plage maxillaire supérieur max",
            "Plage maxillaire inférieur min",
            "Plage maxillaire inférieur max",
            "Plage usure dentaire min",
            "Plage usure dentaire max",
            "Id sutures endocrâniennes",
            "Is sutures endocrâniennes",
            "IId sutures endocrâniennes",
            "IIs sutures endocrâniennes",
            "IIId sutures endocrâniennes",
            "IIIs sutures endocrâniennes",
            "IV sutures endocrâniennes",
            "V sutures endocrâniennes",
            "VI sutures endocrâniennes",
            "VII sutures endocrâniennes",
            "VIIId sutures endocrâniennes",
            "VIIIs sutures endocrâniennes",
            "IXd sutures endocrâniennes",
            "IXs sutures endocrâniennes",
            "Xd sutures endocrâniennes",
            "Xs sutures endocrâniennes",
            "Plage sutures endocrâniennes min",
            "Plage sutures endocrâniennes max",
            "Sutures voûte 1",
            "Sutures voûte 2",
            "Sutures voûte 3",
            "Sutures voûte 4",
            ...
            "Sutures voûte 6",
            "Sutures voûte 7",
            "Sutures antéro latérales 6",
            "Sutures antéro latérales 7",
            "Sutures antéro latérales 8",
            "Sutures antéro latérales 9",
            "Sutures antéro latérales 10",
            "Plage sutures voûte min",
            "Plage sutures voûte max",
            "Plage sutures antéro latérales min",
            "Plage sutures antéro latérales max",
            "Plage sutures ectocrâniennes min",
            "Plage sutures ectocrâniennes max"
        ]
    elif L == 'ar':
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            ...
            "نطاق الارتفاق الحد الأدنى": "sinf_min",
            "نطاق الارتفاق الحد الأقصى": "sinf_max",
            "نطاق الارتفاق الحد الأدنى 2": "sinf_min_2",
            "نطاق الارتفاق الحد الأقصى 2": "sinf_max_2",
            "SSPIA العمر": "SSPIA",
            "SSPIB العمر": "SSPIB",
            "SSPIC العمر": "SSPIC",
            "SSPID العمر": "SSPID",
            "نطاق السطح الأذني الحد الأدنى": "sup_aur_min",
            "نطاق السطح الأذني الحد الأقصى": "sup_aur_max",
            "نطاق السطح الأذني الحد الأدنى 2": "sup_aur_min_2",
            "نطاق السطح الأذني الحد الأقصى 2": "sup_aur_max_2",
            "نطاق الفك العلوي الحد الأدنى": "ms_sup_min",
            "نطاق الفك العلوي الحد الأقصى": "ms_sup_max",
            "نطاق الفك السفلي الحد الأدنى": "ms_inf_min",
            "نطاق الفك السفلي الحد الأقصى": "ms_inf_max",
            "نطاق تآكل الأسنان الحد الأدنى": "usura_min",
            "نطاق تآكل الأسنان الحد الأقصى": "usura_max",
            "Id دروز داخل القحف": "Id_endo",
            "Is دروز داخل القحف": "Is_endo",
            "IId دروز داخل القحف": "IId_endo",
            "IIs دروز داخل القحف": "IIs_endo",
            "IIId دروز داخل القحف": "IIId_endo",
            "IIIs دروز داخل القحف": "IIIs_endo",
            "IV دروز داخل القحف": "IV_endo",
            "V دروز داخل القحف": "V_endo",
            "VI دروز داخل القحف": "VI_endo",
            "VII دروز داخل القحف": "VII_endo",
            "VIIId دروز داخل القحف": "VIIId_endo",
            "VIIIs دروز داخل القحف": "VIIIs_endo",
            "IXd دروز داخل القحف": "IXd_endo",
            "IXs دروز داخل القحف": "IXs_endo",
            "Xd دروز داخل القحف": "Xd_endo",
            "Xs دروز داخل القحف": "Xs_endo",
            "نطاق دروز داخل القحف الحد الأدنى": "endo_min",
            "نطاق دروز داخل القحف الحد الأقصى": "endo_max",
            "دروز القبة 1": "volta_1",
            "دروز القبة 2": "volta_2",
            "دروز القبة 3": "volta_3",
            "دروز القبة 4": "volta_4",
            "دروز القبة 5": "volta_5",
            "دروز القبة 6": "volta_6",
            "دروز القبة 7": "volta_7",
            "دروز أمامية جانبية 6": "lat_6",
            "دروز أمامية جانبية 7": "lat_7",
            "دروز أمامية جانبية 8": "lat_8",
            "دروز أمامية جانبية 9": "lat_9",
            "دروز أمامية جانبية 10": "lat_10",
            "نطاق دروز القبة الحد الأدنى": "volta_min",
            "نطاق دروز القبة الحد الأقصى": "volta_max",
            "نطاق دروز أمامية جانبية الحد الأدنى": "ant_lat_min",
            "نطاق دروز أمامية جانبية الحد الأقصى": "ant_lat_max",
            "نطاق دروز خارج القحف الحد الأدنى": "ecto_min",
            "نطاق دروز خارج القحف الحد الأقصى": "ecto_max"
        }
        SORT_ITEMS = [
            ID_TABLE,
            "الموقع",
            "رقم الفرد",
            "نطاق الارتفاق الحد الأدنى",
            "نطاق الارتفاق الحد الأقصى",
            "نطاق الارتفاق الحد الأدنى 2",
            "نطاق الارتفاق الحد الأقصى 2",
            "SSPIA العمر",
            "SSPIB العمر",
            "SSPIC العمر",
            "SSPID العمر",
            "نطاق السطح الأذني الحد الأدنى",
            "نطاق السطح الأذني الحد الأقصى",
            "نطاق السطح الأذني الحد الأدنى 2",
            "نطاق السطح الأذني الحد الأقصى 2",
            "نطاق الفك العلوي الحد الأدنى",
            "نطاق الفك العلوي الحد الأقصى",
            "نطاق الفك السفلي الحد الأدنى",
            "نطاق الفك السفلي الحد الأقصى",
            "نطاق تآكل الأسنان الحد الأدنى",
            "نطاق تآكل الأسنان الحد الأقصى",
            "Id دروز داخل القحف",
            "Is دروز داخل القحف",
            "IId دروز داخل القحف",
            "IIs دروز داخل القحف",
            "IIId دروز داخل القحف",
            "IIIs دروز داخل القحف",
            "IV دروز داخل القحف",
            "V دروز داخل القحف",
            "VI دروز داخل القحف",
            "VII دروز داخل القحف",
            "VIIId دروز داخل القحف",
            "VIIIs دروز داخل القحف",
            "IXd دروز داخل القحف",
            "IXs دروز داخل القحف",
            "Xd دروز داخل القحف",
            "Xs دروز داخل القحف",
            "نطاق دروز داخل القحف الحد الأدنى",
            "نطاق دروز داخل القحف الحد الأقصى",
            "دروز القبة 1",
            "دروز القبة 2",
            "دروز القبة 3",
            "دروز القبة 4",
            ...
            "دروز القبة 6",
            "دروز القبة 7",
            "دروز أمامية جانبية 6",
            "دروز أمامية جانبية 7",
            "دروز أمامية جانبية 8",
            "دروز أمامية جانبية 9",
            "دروز أمامية جانبية 10",
            "نطاق دروز القبة الحد الأدنى",
            "نطاق دروز القبة الحد الأقصى",
            "نطاق دروز أمامية جانبية الحد الأدنى",
            "نطاق دروز أمامية جانبية الحد الأقصى",
            "نطاق دروز خارج القحف الحد الأدنى",
            "نطاق دروز خارج القحف الحد الأقصى"
        ]
    elif L == 'ca':
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "Lloc": "sito",
            "Num individu": "nr_individuo",
            "Rang simfisi min": "sinf_min",
            "Rang simfisi max": "sinf_max",
            "Rang simfisi min 2": "sinf_min_2",
            "Rang simfisi max 2": "sinf_max_2",
            "SSPIA edat": "SSPIA",
            "SSPIB edat": "SSPIB",
            "SSPIC edat": "SSPIC",
            "SSPID edat": "SSPID",
            "Rang superfície auricular min": "sup_aur_min",
            "Rang superfície auricular max": "sup_aur_max",
            "Rang superfície auricular min 2": "sup_aur_min_2",
            "Rang superfície auricular max 2": "sup_aur_max_2",
            "Rang maxil·lar superior min": "ms_sup_min",
            "Rang maxil·lar superior max": "ms_sup_max",
            "Rang maxil·lar inferior min": "ms_inf_min",
            "Rang maxil·lar inferior max": "ms_inf_max",
            "Rang desgast dental min": "usura_min",
            "Rang desgast dental max": "usura_max",
            "Id sutures endocranials": "Id_endo",
            "Is sutures endocranials": "Is_endo",
            "IId sutures endocranials": "IId_endo",
            "IIs sutures endocranials": "IIs_endo",
            "IIId sutures endocranials": "IIId_endo",
            "IIIs sutures endocranials": "IIIs_endo",
            "IV sutures endocranials": "IV_endo",
            "V sutures endocranials": "V_endo",
            "VI sutures endocranials": "VI_endo",
            "VII sutures endocranials": "VII_endo",
            "VIIId sutures endocranials": "VIIId_endo",
            "VIIIs sutures endocranials": "VIIIs_endo",
            "IXd sutures endocranials": "IXd_endo",
            "IXs sutures endocranials": "IXs_endo",
            "Xd sutures endocranials": "Xd_endo",
            "Xs sutures endocranials": "Xs_endo",
            "Rang sutures endocranials min": "endo_min",
            "Rang sutures endocranials max": "endo_max",
            "Sutures volta 1": "volta_1",
            "Sutures volta 2": "volta_2",
            "Sutures volta 3": "volta_3",
            "Sutures volta 4": "volta_4",
            "Sutures volta 5": "volta_5",
            "Sutures volta 6": "volta_6",
            "Sutures volta 7": "volta_7",
            "Sutures antero laterals 6": "lat_6",
            "Sutures antero laterals 7": "lat_7",
            "Sutures antero laterals 8": "lat_8",
            "Sutures antero laterals 9": "lat_9",
            "Sutures antero laterals 10": "lat_10",
            "Rang sutures volta min": "volta_min",
            "Rang sutures volta max": "volta_max",
            "Rang sutures antero laterals min": "ant_lat_min",
            "Rang sutures antero laterals max": "ant_lat_max",
            "Rang sutures ectocranials min": "ecto_min",
            "Rang sutures ectocranials max": "ecto_max"
        }
        SORT_ITEMS = [
            ID_TABLE,
            "Lloc",
            ...
            "SSPIC edat",
            "SSPID edat",
            "Rang superfície auricular min",
            "Rang superfície auricular max",
            "Rang superfície auricular min 2",
            "Rang superfície auricular max 2",
            "Rang maxil·lar superior min",
            "Rang maxil·lar superior max",
            "Rang maxil·lar inferior min",
            "Rang maxil·lar inferior max",
            "Rang desgast dental min",
            "Rang desgast dental max",
            "Id sutures endocranials",
            "Is sutures endocranials",
            "IId sutures endocranials",
            "IIs sutures endocranials",
            "IIId sutures endocranials",
            "IIIs sutures endocranials",
            "IV sutures endocranials",
            "V sutures endocranials",
            "VI sutures endocranials",
            "VII sutures endocranials",
            "VIIId sutures endocranials",
            "VIIIs sutures endocranials",
            "IXd sutures endocranials",
            "IXs sutures endocranials",
            "Xd sutures endocranials",
            "Xs sutures endocranials",
            "Rang sutures endocranials min",
            "Rang sutures endocranials max",
            "Sutures volta 1",
            "Sutures volta 2",
            "Sutures volta 3",
            "Sutures volta 4",
            ...
            "Sutures volta 6",
            "Sutures volta 7",
            "Sutures antero laterals 6",
            "Sutures antero laterals 7",
            "Sutures antero laterals 8",
            "Sutures antero laterals 9",
            "Sutures antero laterals 10",
            "Rang sutures volta min",
            "Rang sutures volta max",
            "Rang sutures antero laterals min",
            "Rang sutures antero laterals max",
            "Rang sutures ectocranials min",
            "Rang sutures ectocranials max"
        ]
    elif L == 'ro':
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            ...
            "Interval simfiză min": "sinf_min",
            "Interval simfiză max": "sinf_max",
            "Interval simfiză min 2": "sinf_min_2",
            "Interval simfiză max 2": "sinf_max_2",
            "SSPIA vârstă": "SSPIA",
            "SSPIB vârstă": "SSPIB",
            "SSPIC vârstă": "SSPIC",
            "SSPID vârstă": "SSPID",
            "Interval suprafață auriculară min": "sup_aur_min",
            "Interval suprafață auriculară max": "sup_aur_max",
            "Interval suprafață auriculară min 2": "sup_aur_min_2",
            "Interval suprafață auriculară max 2": "sup_aur_max_2",
            "Interval maxilar superior min": "ms_sup_min",
            "Interval maxilar superior max": "ms_sup_max",
            "Interval maxilar inferior min": "ms_inf_min",
            "Interval maxilar inferior max": "ms_inf_max",
            "Interval uzură dentară min": "usura_min",
            "Interval uzură dentară max": "usura_max",
            "Id suturi endocraniene": "Id_endo",
            "Is suturi endocraniene": "Is_endo",
            "IId suturi endocraniene": "IId_endo",
            "IIs suturi endocraniene": "IIs_endo",
            "IIId suturi endocraniene": "IIId_endo",
            "IIIs suturi endocraniene": "IIIs_endo",
            "IV suturi endocraniene": "IV_endo",
            "V suturi endocraniene": "V_endo",
            "VI suturi endocraniene": "VI_endo",
            "VII suturi endocraniene": "VII_endo",
            "VIIId suturi endocraniene": "VIIId_endo",
            "VIIIs suturi endocraniene": "VIIIs_endo",
            "IXd suturi endocraniene": "IXd_endo",
            "IXs suturi endocraniene": "IXs_endo",
            "Xd suturi endocraniene": "Xd_endo",
            "Xs suturi endocraniene": "Xs_endo",
            "Interval suturi endocraniene min": "endo_min",
            "Interval suturi endocraniene max": "endo_max",
            "Suturi boltă 1": "volta_1",
            "Suturi boltă 2": "volta_2",
            "Suturi boltă 3": "volta_3",
            "Suturi boltă 4": "volta_4",
            "Suturi boltă 5": "volta_5",
            "Suturi boltă 6": "volta_6",
            "Suturi boltă 7": "volta_7",
            "Suturi antero laterale 6": "lat_6",
            "Suturi antero laterale 7": "lat_7",
            "Suturi antero laterale 8": "lat_8",
            "Suturi antero laterale 9": "lat_9",
            "Suturi antero laterale 10": "lat_10",
            "Interval suturi boltă min": "volta_min",
            "Interval suturi boltă max": "volta_max",
            "Interval suturi antero laterale min": "ant_lat_min",
            "Interval suturi antero laterale max": "ant_lat_max",
            "Interval suturi ectocraniene min": "ecto_min",
            "Interval suturi ectocraniene max": "ecto_max"
        }
        SORT_ITEMS = [
            ID_TABLE,
            "Sit",
            "Nr. individ",
            "Interval simfiză min",
            "Interval simfiză max",
            "Interval simfiză min 2",
            "Interval simfiză max 2",
            "SSPIA vârstă",
            "SSPIB vârstă",
            "SSPIC vârstă",
            "SSPID vârstă",
            "Interval suprafață auriculară min",
            "Interval suprafață auriculară max",
            "Interval suprafață auriculară min 2",
            "Interval suprafață auriculară max 2",
            "Interval maxilar superior min",
            "Interval maxilar superior max",
            "Interval maxilar inferior min",
            "Interval maxilar inferior max",
            "Interval uzură dentară min",
            "Interval uzură dentară max",
            "Id suturi endocraniene",
            "Is suturi endocraniene",
            "IId suturi endocraniene",
            "IIs suturi endocraniene",
            "IIId suturi endocraniene",
            "IIIs suturi endocraniene",
            "IV suturi endocraniene",
            "V suturi endocraniene",
            "VI suturi endocraniene",
            "VII suturi endocraniene",
            "VIIId suturi endocraniene",
            "VIIIs suturi endocraniene",
            "IXd suturi endocraniene",
            "IXs suturi endocraniene",
            "Xd suturi endocraniene",
            "Xs suturi endocraniene",
            "Interval suturi endocraniene min",
            "Interval suturi endocraniene max",
            "Suturi boltă 1",
            "Suturi boltă 2",
            "Suturi boltă 3",
            "Suturi boltă 4",
            ...
            "Suturi boltă 6",
            "Suturi boltă 7",
            "Suturi antero laterale 6",
            "Suturi antero laterale 7",
            "Suturi antero laterale 8",
            "Suturi antero laterale 9",
            "Suturi antero laterale 10",
            "Interval suturi boltă min",
            "Interval suturi boltă max",
            "Interval suturi antero laterale min",
            "Interval suturi antero laterale max",
            "Interval suturi ectocraniene min",
            "Interval suturi ectocraniene max"
        ]
    elif L == 'pt':
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "Sítio": "sito",
            "N. indivíduo": "nr_individuo",
            "Intervalo sínfise min": "sinf_min",
            "Intervalo sínfise max": "sinf_max",
            "Intervalo sínfise min 2": "sinf_min_2",
            "Intervalo sínfise max 2": "sinf_max_2",
            "SSPIA idade": "SSPIA",
            "SSPIB idade": "SSPIB",
            "SSPIC idade": "SSPIC",
            "SSPID idade": "SSPID",
            "Intervalo superfície auricular min": "sup_aur_min",
            "Intervalo superfície auricular max": "sup_aur_max",
            "Intervalo superfície auricular min 2": "sup_aur_min_2",
            "Intervalo superfície auricular max 2": "sup_aur_max_2",
            "Intervalo maxilar superior min": "ms_sup_min",
            "Intervalo maxilar superior max": "ms_sup_max",
            "Intervalo maxilar inferior min": "ms_inf_min",
            "Intervalo maxilar inferior max": "ms_inf_max",
            "Intervalo desgaste dentário min": "usura_min",
            "Intervalo desgaste dentário max": "usura_max",
            "Id suturas endocranianas": "Id_endo",
            "Is suturas endocranianas": "Is_endo",
            "IId suturas endocranianas": "IId_endo",
            "IIs suturas endocranianas": "IIs_endo",
            "IIId suturas endocranianas": "IIId_endo",
            "IIIs suturas endocranianas": "IIIs_endo",
            "IV suturas endocranianas": "IV_endo",
            "V suturas endocranianas": "V_endo",
            "VI suturas endocranianas": "VI_endo",
            "VII suturas endocranianas": "VII_endo",
            "VIIId suturas endocranianas": "VIIId_endo",
            "VIIIs suturas endocranianas": "VIIIs_endo",
            "IXd suturas endocranianas": "IXd_endo",
            "IXs suturas endocranianas": "IXs_endo",
            "Xd suturas endocranianas": "Xd_endo",
            "Xs suturas endocranianas": "Xs_endo",
            "Intervalo suturas endocranianas min": "endo_min",
            "Intervalo suturas endocranianas max": "endo_max",
            "Suturas abóbada 1": "volta_1",
            "Suturas abóbada 2": "volta_2",
            "Suturas abóbada 3": "volta_3",
            "Suturas abóbada 4": "volta_4",
            "Suturas abóbada 5": "volta_5",
            "Suturas abóbada 6": "volta_6",
            "Suturas abóbada 7": "volta_7",
            "Suturas antero laterais 6": "lat_6",
            "Suturas antero laterais 7": "lat_7",
            "Suturas antero laterais 8": "lat_8",
            "Suturas antero laterais 9": "lat_9",
            "Suturas antero laterais 10": "lat_10",
            "Intervalo suturas abóbada min": "volta_min",
            "Intervalo suturas abóbada max": "volta_max",
            "Intervalo suturas antero laterais min": "ant_lat_min",
            "Intervalo suturas antero laterais max": "ant_lat_max",
            "Intervalo suturas ectocranianas min": "ecto_min",
            "Intervalo suturas ectocranianas max": "ecto_max"
        }
        SORT_ITEMS = [
            ID_TABLE,
            "Sítio",
            "N. indivíduo",
            "Intervalo sínfise min",
            "Intervalo sínfise max",
            "Intervalo sínfise min 2",
            "Intervalo sínfise max 2",
            "SSPIA idade",
            "SSPIB idade",
            "SSPIC idade",
            "SSPID idade",
            "Intervalo superfície auricular min",
            "Intervalo superfície auricular max",
            "Intervalo superfície auricular min 2",
            "Intervalo superfície auricular max 2",
            "Intervalo maxilar superior min",
            "Intervalo maxilar superior max",
            "Intervalo maxilar inferior min",
            "Intervalo maxilar inferior max",
            "Intervalo desgaste dentário min",
            "Intervalo desgaste dentário max",
            "Id suturas endocranianas",
            "Is suturas endocranianas",
            "IId suturas endocranianas",
            "IIs suturas endocranianas",
            "IIId suturas endocranianas",
            "IIIs suturas endocranianas",
            "IV suturas endocranianas",
            "V suturas endocranianas",
            "VI suturas endocranianas",
            "VII suturas endocranianas",
            "VIIId suturas endocranianas",
            "VIIIs suturas endocranianas",
            "IXd suturas endocranianas",
            "IXs suturas endocranianas",
            "Xd suturas endocranianas",
            "Xs suturas endocranianas",
            "Intervalo suturas endocranianas min",
            "Intervalo suturas endocranianas max",
            "Suturas abóbada 1",
            "Suturas abóbada 2",
            "Suturas abóbada 3",
            "Suturas abóbada 4",
            ...
            "Suturas abóbada 6",
            "Suturas abóbada 7",
            "Suturas antero laterais 6",
            "Suturas antero laterais 7",
            "Suturas antero laterais 8",
            "Suturas antero laterais 9",
            "Suturas antero laterais 10",
            "Intervalo suturas abóbada min",
            "Intervalo suturas abóbada max",
            "Intervalo suturas antero laterais min",
            "Intervalo suturas antero laterais max",
            "Intervalo suturas ectocranianas min",
            "Intervalo suturas ectocranianas max"
        ]
    elif L == 'el':
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            ...
            "Εύρος σύμφυσης ελάχ.": "sinf_min",
            "Εύρος σύμφυσης μέγ.": "sinf_max",
            "Εύρος σύμφυσης ελάχ. 2": "sinf_min_2",
            "Εύρος σύμφυσης μέγ. 2": "sinf_max_2",
            "SSPIA ηλικία": "SSPIA",
            "SSPIB ηλικία": "SSPIB",
            "SSPIC ηλικία": "SSPIC",
            "SSPID ηλικία": "SSPID",
            "Εύρος ωτικής επιφάνειας ελάχ.": "sup_aur_min",
            "Εύρος ωτικής επιφάνειας μέγ.": "sup_aur_max",
            "Εύρος ωτικής επιφάνειας ελάχ. 2": "sup_aur_min_2",
            "Εύρος ωτικής επιφάνειας μέγ. 2": "sup_aur_max_2",
            "Εύρος άνω γνάθου ελάχ.": "ms_sup_min",
            "Εύρος άνω γνάθου μέγ.": "ms_sup_max",
            "Εύρος κάτω γνάθου ελάχ.": "ms_inf_min",
            "Εύρος κάτω γνάθου μέγ.": "ms_inf_max",
            "Εύρος οδοντικής φθοράς ελάχ.": "usura_min",
            "Εύρος οδοντικής φθοράς μέγ.": "usura_max",
            "Id ενδοκρανιακές ραφές": "Id_endo",
            "Is ενδοκρανιακές ραφές": "Is_endo",
            "IId ενδοκρανιακές ραφές": "IId_endo",
            "IIs ενδοκρανιακές ραφές": "IIs_endo",
            "IIId ενδοκρανιακές ραφές": "IIId_endo",
            "IIIs ενδοκρανιακές ραφές": "IIIs_endo",
            "IV ενδοκρανιακές ραφές": "IV_endo",
            "V ενδοκρανιακές ραφές": "V_endo",
            "VI ενδοκρανιακές ραφές": "VI_endo",
            "VII ενδοκρανιακές ραφές": "VII_endo",
            "VIIId ενδοκρανιακές ραφές": "VIIId_endo",
            "VIIIs ενδοκρανιακές ραφές": "VIIIs_endo",
            "IXd ενδοκρανιακές ραφές": "IXd_endo",
            "IXs ενδοκρανιακές ραφές": "IXs_endo",
            "Xd ενδοκρανιακές ραφές": "Xd_endo",
            "Xs ενδοκρανιακές ραφές": "Xs_endo",
            "Εύρος ενδοκρανιακών ραφών ελάχ.": "endo_min",
            "Εύρος ενδοκρανιακών ραφών μέγ.": "endo_max",
            "Ραφές θόλου 1": "volta_1",
            "Ραφές θόλου 2": "volta_2",
            "Ραφές θόλου 3": "volta_3",
            "Ραφές θόλου 4": "volta_4",
            "Ραφές θόλου 5": "volta_5",
            "Ραφές θόλου 6": "volta_6",
            "Ραφές θόλου 7": "volta_7",
            "Ραφές πρόσθιες πλάγιες 6": "lat_6",
            "Ραφές πρόσθιες πλάγιες 7": "lat_7",
            "Ραφές πρόσθιες πλάγιες 8": "lat_8",
            "Ραφές πρόσθιες πλάγιες 9": "lat_9",
            "Ραφές πρόσθιες πλάγιες 10": "lat_10",
            "Εύρος ραφών θόλου ελάχ.": "volta_min",
            "Εύρος ραφών θόλου μέγ.": "volta_max",
            "Εύρος πρόσθιων πλάγιων ραφών ελάχ.": "ant_lat_min",
            "Εύρος πρόσθιων πλάγιων ραφών μέγ.": "ant_lat_max",
            "Εύρος εξωκρανιακών ραφών ελάχ.": "ecto_min",
            "Εύρος εξωκρανιακών ραφών μέγ.": "ecto_max"
        }
        SORT_ITEMS = [
            ID_TABLE,
            "Θέση",
            ...
            "Εύρος σύμφυσης ελάχ.",
            "Εύρος σύμφυσης μέγ.",
            "Εύρος σύμφυσης ελάχ. 2",
            "Εύρος σύμφυσης μέγ. 2",
            "SSPIA ηλικία",
            "SSPIB ηλικία",
            "SSPIC ηλικία",
            "SSPID ηλικία",
            "Εύρος ωτικής επιφάνειας ελάχ.",
            "Εύρος ωτικής επιφάνειας μέγ.",
            "Εύρος ωτικής επιφάνειας ελάχ. 2",
            "Εύρος ωτικής επιφάνειας μέγ. 2",
            "Εύρος άνω γνάθου ελάχ.",
            "Εύρος άνω γνάθου μέγ.",
            "Εύρος κάτω γνάθου ελάχ.",
            "Εύρος κάτω γνάθου μέγ.",
            "Εύρος οδοντικής φθοράς ελάχ.",
            "Εύρος οδοντικής φθοράς μέγ.",
            "Id ενδοκρανιακές ραφές",
            "Is ενδοκρανιακές ραφές",
            "IId ενδοκρανιακές ραφές",
            "IIs ενδοκρανιακές ραφές",
            "IIId ενδοκρανιακές ραφές",
            "IIIs ενδοκρανιακές ραφές",
            "IV ενδοκρανιακές ραφές",
            "V ενδοκρανιακές ραφές",
            "VI ενδοκρανιακές ραφές",
            "VII ενδοκρανιακές ραφές",
            "VIIId ενδοκρανιακές ραφές",
            "VIIIs ενδοκρανιακές ραφές",
            "IXd ενδοκρανιακές ραφές",
            "IXs ενδοκρανιακές ραφές",
            "Xd ενδοκρανιακές ραφές",
            "Xs ενδοκρανιακές ραφές",
            "Εύρος ενδοκρανιακών ραφών ελάχ.",
            "Εύρος ενδοκρανιακών ραφών μέγ.",
            "Ραφές θόλου 1",
            "Ραφές θόλου 2",
            "Ραφές θόλου 3",
            "Ραφές θόλου 4",
            ...
            "Ραφές θόλου 6",
            "Ραφές θόλου 7",
            "Ραφές πρόσθιες πλάγιες 6",
            "Ραφές πρόσθιες πλάγιες 7",
            "Ραφές πρόσθιες πλάγιες 8",
            "Ραφές πρόσθιες πλάγιες 9",
            "Ραφές πρόσθιες πλάγιες 10",
            "Εύρος ραφών θόλου ελάχ.",
            "Εύρος ραφών θόλου μέγ.",
            "Εύρος πρόσθιων πλάγιων ραφών ελάχ.",
            "Εύρος πρόσθιων πλάγιων ραφών μέγ.",
            "Εύρος εξωκρανιακών ραφών ελάχ.",
            "Εύρος εξωκρανιακών ραφών μέγ."
        ]
        ...
        if hasattr(self, 'concurrency_manager'):
            try:
                if n < len(self.DATA_LIST):
                    ...
                    if hasattr(current_record, 'id_det_eta'):
                        self.editing_record_id = getattr(current_record, 'id_det_eta')
