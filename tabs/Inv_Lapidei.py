...
class pyarchinit_Inventario_Lapidei(QDialog, MAIN_DIALOG_CLASS):
    ...
    if L=='it':
        ...
        CONVERSION_DICT = {
            ...
            "Processing and state of preservation": 'lavorazione_e_stato_di_conservazione',
        ...
        SORT_ITEMS = [
            ...
            "h",
            "Description",
            "Processing and state of preservation",
            "Comparisons",
            "Chronology",
            "Bibliography",
            "Filler"
        ...
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "Sitio": "sito",
            "Nº ficha": "scheda_numero",
            "Ubicación": "collocazione",
            "Objeto": "oggetto",
            "Tipología": "tipologia",
            "Material": "materiale",
            "D (lecho)": "d_letto_posa",
            "D (lecho espera)": "d_letto_attesa",
            "Toro": "toro",
            "Espesor": "spessore",
            "Ancho": "larghezza",
            "Longitud": "lunghezza",
            ...
            "Procesamiento y estado de conservación": 'lavorazione_e_stato_di_conservazione',
        ...
        SORT_ITEMS = [
            ...
            "h",
            "Descripción",
            "Procesamiento y estado de conservación",
            "Comparaciones",
            "Cronología",
            "Bibliografía",
            "Autor"
        ...
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "Site": "sito",
            "Nº fiche": "scheda_numero",
            "Emplacement": "collocazione",
            "Objet": "oggetto",
            "Typologie": "tipologia",
            "Matériau": "materiale",
            "D (lit de pose)": "d_letto_posa",
            "D (lit d'attente)": "d_letto_attesa",
            "Tore": "toro",
            "Épaisseur": "spessore",
            "Largeur": "larghezza",
            "Longueur": "lunghezza",
            "h": 'h',
            "Description": 'descrizione',
            "Traitement et état de conservation": 'lavorazione_e_stato_di_conservazione',
        ...
        SORT_ITEMS = [
            ...
            "h",
            "Description",
            "Traitement et état de conservation",
            "Comparaisons",
            "Chronologie",
            "Bibliographie",
            "Auteur"
        ...
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "موقع": "sito",
            "رقم البطاقة": "scheda_numero",
            "موقع": "collocazione",
            "كائن": "oggetto",
            "تصنيف": "tipologia",
            "مادة": "materiale",
            "D (فراش)": "d_letto_posa",
            "D (فراش انتظار)": "d_letto_attesa",
            "طور": "toro",
            "سمك": "spessore",
            "عرض": "larghezza",
            "طول": "lunghezza",
            "h": 'h',
            "وصف": 'descrizione',
            "المعالجة وحالة الحفظ": 'lavorazione_e_stato_di_conservazione',
            "مقارنات": 'confronti',
            "تسلسل زمني": 'cronologia',
            "ببليوغرافيا": 'bibliografia',
            "المؤلف": 'compilatore'
        }
        ...
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "Jaciment": "sito",
            "Nº fitxa": "scheda_numero",
            "Ubicació": "collocazione",
            "Objecte": "oggetto",
            "Tipologia": "tipologia",
            "Material": "materiale",
            "D (llit)": "d_letto_posa",
            "D (llit espera)": "d_letto_attesa",
            "Tor": "toro",
            "Gruix": "spessore",
            "Amplada": "larghezza",
            "Longitud": "lunghezza",
            ...
            "Processament i estat de conservació": 'lavorazione_e_stato_di_conservazione',
        ...
        SORT_ITEMS = [
            ...
            "h",
            "Descripció",
            "Processament i estat de conservació",
            "Comparacions",
            "Cronologia",
            "Bibliografia",
            "Autor"
        ...
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "Sit": "sito",
            "Nr. fișă": "scheda_numero",
            "Localizare": "collocazione",
            "Obiect": "oggetto",
            "Tipologie": "tipologia",
            "Material": "materiale",
            "D (pat)": "d_letto_posa",
            "D (pat așteptare)": "d_letto_attesa",
            "Tor": "toro",
            "Grosime": "spessore",
            "Lățime": "larghezza",
            "Lungime": "lunghezza",
            ...
            "Prelucrare și stare de conservare": 'lavorazione_e_stato_di_conservazione',
            "Comparații": 'confronti',
        ...
        SORT_ITEMS = [
            ...
            "h",
            "Descriere",
            "Prelucrare și stare de conservare",
            "Comparații",
            "Cronologie",
            "Bibliografie",
            "Autor"
        ...
        CONVERSION_DICT = {
            ...
            "Sítio": "sito",
            "Nº ficha": "scheda_numero",
            "Localização": "collocazione",
            "Objeto": "oggetto",
            "Tipologia": "tipologia",
            "Material": "materiale",
            "D (leito)": "d_letto_posa",
            "D (leito espera)": "d_letto_attesa",
            "Toro": "toro",
            "Espessura": "spessore",
            "Largura": "larghezza",
            ...
            "Processamento e estado de conservação": 'lavorazione_e_stato_di_conservazione',
        ...
        SORT_ITEMS = [
            ...
            "h",
            "Descrição",
            "Processamento e estado de conservação",
            "Comparações",
            "Cronologia",
            "Bibliografia",
            "Autor"
        ...
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "Θέση": "sito",
            "Αρ. δελτίου": "scheda_numero",
            "Τοποθεσία": "collocazione",
            "Αντικείμενο": "oggetto",
            "Τυπολογία": "tipologia",
            "Υλικό": "materiale",
            "D (στρώση)": "d_letto_posa",
            "D (στρώση αναμονής)": "d_letto_attesa",
            "Τόρος": "toro",
            "Πάχος": "spessore",
            "Πλάτος": "larghezza",
            "Μήκος": "lunghezza",
            ...
            "Επεξεργασία και κατάσταση διατήρησης": 'lavorazione_e_stato_di_conservazione',
            "Συγκρίσεις": 'confronti',
            "Χρονολογία": 'cronologia',
            "Βιβλιογραφία": 'bibliografia',
            "Συντάκτης": 'compilatore'
        }
        ...
        SORT_ITEMS = [
            ...
            "h",
            "Περιγραφή",
            "Επεξεργασία και κατάσταση διατήρησης",
            "Συγκρίσεις",
            "Χρονολογία",
            "Βιβλιογραφία",
            "Συντάκτης"
