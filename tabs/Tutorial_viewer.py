...
class TutorialViewerDialog(QDialog):
    ...
    TUTORIALS_METADATA = {
        ...
        'ro': [
            ...
            ("02_scheda_sito.md", "Fișa Sit", "Gestionarea siturilor arheologice"),
            ("03_scheda_us.md", "Fișa US/USM", "Unități Stratigrafice și Murale"),
            ("04_scheda_periodizzazione.md", "Periodizare", "Faze și perioade cronologice"),
            ("05_scheda_struttura.md", "Fișa Structură", "Documentarea structurilor"),
            ("06_scheda_tomba.md", "Fișa Mormânt", "Morminte și inventar funerar"),
            ("07_scheda_individui.md", "Fișa Indivizi", "Antropologie fizică"),
            ("08_scheda_inventario_materiali.md", "Inventar Materiale", "Gestionarea artefactelor"),
            ("09_scheda_campioni.md", "Fișa Eșantioane", "Eșantionare"),
            ("10_scheda_documentazione.md", "Documentație", "Fotografii, desene, relevee"),
            ("11_matrix_harris.md", "Matricea Harris", "Generarea diagramelor stratigrafice"),
            ("12_report_stampe.md", "Rapoarte și Tipărire", "Generarea documentației PDF"),
            ("13_thesaurus.md", "Tezaur", "Gestionarea vocabularelor controlate"),
            ("14_gis_cartografia.md", "GIS și Cartografie", "Integrare QGIS și SAM Segmentation"),
            ("15_archeozoologia.md", "Arheozoologie", "Analize faunistice"),
            ("16_scheda_pottery.md", "Ceramică/Pottery", "Fișă ceramică specializată"),
            ("17_tma.md", "TMA", "Tabele Materiale Arheologice"),
            ("18_backup.md", "Backup și Restaurare", "Gestionarea backup-urilor bazei de date"),
            ("19_multiutente.md", "Multi-utilizator", "Lucru colaborativ PostgreSQL"),
            ("20_pubblicazione_web.md", "Publicare Web", "Export și Lizmap"),
            ("21_scheda_ut.md", "Fișa UT", "Unități Topografice / Survey"),
            ("22_media_manager.md", "Manager Media", "Gestionarea multimedia și atașamentelor"),
            ("23_ricerca_immagini.md", "Căutare Imagini", "Căutare globală imagini"),
            ("24_esporta_immagini.md", "Export Imagini", "Export imagini pe Perioadă/Fază/US"),
            ("25_time_manager.md", "Manager Timp", "Navigare temporală stratigrafică"),
            ("26_pottery_tools.md", "Instrumente Ceramică", "Instrumente procesare ceramică"),
            ("27_tops.md", "TOPS", "Integrare Total Open Station"),
        ...
        'pt': [
            ...
            ("02_scheda_sito.md", "Ficha de Sítio", "Gestão de sítios arqueológicos"),
            ("03_scheda_us.md", "Ficha UE/UEM", "Unidades Estratigráficas e Murais"),
            ("04_scheda_periodizzazione.md", "Periodização", "Fases e períodos cronológicos"),
            ("05_scheda_struttura.md", "Ficha Estrutura", "Documentação de estruturas"),
            ("06_scheda_tomba.md", "Ficha Sepultura", "Sepulturas e espólio funerário"),
            ("07_scheda_individui.md", "Ficha Indivíduos", "Antropologia física"),
            ("08_scheda_inventario_materiali.md", "Inventário de Materiais", "Gestão de artefactos"),
            ("09_scheda_campioni.md", "Ficha Amostras", "Amostragem"),
            ("10_scheda_documentazione.md", "Documentação", "Fotografias, desenhos, levantamentos"),
            ("11_matrix_harris.md", "Matriz de Harris", "Geração de diagramas estratigráficos"),
            ("12_report_stampe.md", "Relatórios e Impressão", "Geração de documentação PDF"),
            ("13_thesaurus.md", "Tesauro", "Gestão de vocabulários controlados"),
            ("14_gis_cartografia.md", "SIG e Cartografia", "Integração QGIS e SAM Segmentation"),
            ("15_archeozoologia.md", "Arqueozoologia", "Análises faunísticas"),
            ("16_scheda_pottery.md", "Cerâmica/Pottery", "Ficha cerâmica especializada"),
            ("17_tma.md", "TMA", "Tabelas de Materiais Arqueológicos"),
            ("18_backup.md", "Backup e Restauro", "Gestão de backups da base de dados"),
            ("19_multiutente.md", "Multi-utilizador", "Trabalho colaborativo PostgreSQL"),
            ("20_pubblicazione_web.md", "Publicação Web", "Exportação e Lizmap"),
            ("21_scheda_ut.md", "Ficha UT", "Unidades Topográficas / Survey"),
            ("22_media_manager.md", "Gestor de Media", "Gestão multimédia e anexos"),
            ("23_ricerca_immagini.md", "Pesquisa de Imagens", "Pesquisa global de imagens"),
            ("24_esporta_immagini.md", "Exportar Imagens", "Exportação de imagens por Período/Fase/UE"),
            ("25_time_manager.md", "Gestor de Tempo", "Navegação temporal estratigráfica"),
            ("26_pottery_tools.md", "Ferramentas Cerâmica", "Ferramentas de processamento cerâmico"),
            ("27_tops.md", "TOPS", "Integração Total Open Station"),
        ...
        'el': [
            ...
            ("02_scheda_sito.md", "Δελτίο Θέσης", "Διαχείριση αρχαιολογικών θέσεων"),
            ("03_scheda_us.md", "Δελτίο ΣΜ/ΤΣΜ", "Στρωματογραφικές και Τοιχοποιητικές Μονάδες"),
            ("04_scheda_periodizzazione.md", "Περιοδολόγηση", "Χρονολογικές φάσεις και περίοδοι"),
            ("05_scheda_struttura.md", "Δελτίο Κατασκευής", "Τεκμηρίωση κατασκευών"),
            ("06_scheda_tomba.md", "Δελτίο Τάφου", "Ταφές και κτερίσματα"),
            ("07_scheda_individui.md", "Δελτίο Ατόμων", "Φυσική ανθρωπολογία"),
            ("08_scheda_inventario_materiali.md", "Κατάλογος Υλικών", "Διαχείριση ευρημάτων"),
            ("09_scheda_campioni.md", "Δελτίο Δειγμάτων", "Δειγματοληψία"),
            ("10_scheda_documentazione.md", "Τεκμηρίωση", "Φωτογραφίες, σχέδια, αποτυπώσεις"),
            ("11_matrix_harris.md", "Μήτρα Harris", "Δημιουργία στρωματογραφικών διαγραμμάτων"),
            ("12_report_stampe.md", "Αναφορές και Εκτυπώσεις", "Δημιουργία τεκμηρίωσης PDF"),
            ("13_thesaurus.md", "Θησαυρός", "Διαχείριση ελεγχόμενων λεξιλογίων"),
            ("14_gis_cartografia.md", "GIS και Χαρτογραφία", "Ενσωμάτωση QGIS και SAM Segmentation"),
            ("15_archeozoologia.md", "Αρχαιοζωολογία", "Πανιδικές αναλύσεις"),
            ("16_scheda_pottery.md", "Κεραμική/Pottery", "Εξειδικευμένο δελτίο κεραμικής"),
            ("17_tma.md", "TMA", "Πίνακες Αρχαιολογικών Υλικών"),
            ("18_backup.md", "Αντίγραφα Ασφαλείας", "Διαχείριση αντιγράφων βάσης δεδομένων"),
            ("19_multiutente.md", "Πολυχρηστικό", "Συνεργατική εργασία PostgreSQL"),
            ("20_pubblicazione_web.md", "Δημοσίευση Web", "Εξαγωγή και Lizmap"),
            ("21_scheda_ut.md", "Δελτίο ΤΜ", "Τοπογραφικές Μονάδες / Επιφανειακή έρευνα"),
            ("22_media_manager.md", "Διαχείριση Μέσων", "Διαχείριση πολυμέσων και συνημμένων"),
            ("23_ricerca_immagini.md", "Αναζήτηση Εικόνων", "Καθολική αναζήτηση εικόνων"),
            ("24_esporta_immagini.md", "Εξαγωγή Εικόνων", "Εξαγωγή εικόνων ανά Περίοδο/Φάση/ΣΜ"),
            ("25_time_manager.md", "Διαχείριση Χρόνου", "Χρονική πλοήγηση στρωματογραφίας"),
            ("26_pottery_tools.md", "Εργαλεία Κεραμικής", "Εργαλεία επεξεργασίας κεραμικής"),
            ("27_tops.md", "TOPS", "Ενσωμάτωση Total Open Station"),
    ...
    UI_LABELS = {
        ...
        'el': {
            'window_title': 'PyArchInit - Οδηγοί & Τεκμηρίωση',
            'search': 'Αναζήτηση:',
            'search_placeholder': 'Αναζήτηση στους οδηγούς...',
            'available': 'Διαθέσιμοι Οδηγοί:',
            'content': 'Περιεχόμενο:',
            'close': 'Κλείσιμο',
            'back': 'Πίσω',
            'language': 'Γλώσσα:',
            'not_available': 'Ο οδηγός δεν είναι διαθέσιμος',
            'file_not_found': 'Το αρχείο δεν βρέθηκε.',
            'path': 'Διαδρομή',
            'load_error': 'Σφάλμα φόρτωσης',
            'error_loading': 'Παρουσιάστηκε σφάλμα κατά τη φόρτωση του οδηγού:',
        },
    }
