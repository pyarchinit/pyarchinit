...
class pyarchinit_Tomba(QDialog, MAIN_DIALOG_CLASS):
    ...
    if L=='it':
        ...
        CONVERSION_DICT = {
            ...
            "Canal libatorio": "canale_libatorio_si_no",
            "Objetos externos": "oggetti_rinvenuti_esterno",
        ...
        CONVERSION_DICT = {
            ...
            "Objets externes": "oggetti_rinvenuti_esterno",
        ...
        CONVERSION_DICT = {
            ...
            "Objectes externs": "oggetti_rinvenuti_esterno",
        ...
        CONVERSION_DICT = {
            ...
            "Obiecte externe": "oggetti_rinvenuti_esterno",
            "Stare de conservare": "stato_di_conservazione",
            "Tip acoperire": "copertura_tipo",
            "Tip container": "tipo_contenitore_resti",
    ...
    def on_pushButton_crea_codice_periodo_pressed(self):
        ...
        QMessageBox.warning(self, "Attenzione", "Codice periodo aggiornato per lo scavo %s" % (sito), QMessageBox.StandardButton.Ok)
