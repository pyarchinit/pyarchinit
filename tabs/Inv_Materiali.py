...
class pyarchinit_Inventario_reperti(QDialog, MAIN_DIALOG_CLASS):
    ...
    if L =='it':
        ...
        CONVERSION_DICT = {
            ...
            "Tipo hallazgo": "tipo_reperto",
            "Clase material": "criterio_schedatura",
            ...
            "Lavado": "lavato",
            "Caja": "nr_cassa",
            "Lugar conservación": "luogo_conservazione",
            "Estado conservación": "stato_conservazione",
            "Datación hallazgo": "datazione_reperto",
            "Formas mínimas": 'forme_minime',
            "Formas máximas": 'forme_massime',
            "Total fragmentos": 'totale_frammenti',
            "Cuerpo cerámico": 'corpo_ceramico',
            "Revestimiento": 'rivestimento',
            "Diámetro borde": 'diametro_orlo',
            "Peso": 'peso',
            "Tipo": 'tipo',
            "Valor E.v.e. borde": 'eve_orlo',
            "Registrado": 'repertato',
            "Diagnóstico": 'diagnostico',
            "RA": 'n_reperto',
            "Tipo contenedor": 'tipo_contenitore',
            "Estructura": 'struttura',
            "Año": 'years'
        }
        QUANT_ITEMS = ['Tipo hallazgo',
                       'Clase material',
                       'Definición',
                       'Cuerpo cerámico',
                       'Revestimiento',
        ...
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "Site": "sito",
            "Nº inventaire": "numero_inventario",
            "Type trouvaille": "tipo_reperto",
            "Classe matériau": "criterio_schedatura",
            ...
            "Lavé": "lavato",
            "Caisse": "nr_cassa",
            "Lieu conservation": "luogo_conservazione",
            "État conservation": "stato_conservazione",
            "Datation trouvaille": "datazione_reperto",
            "Formes minimales": 'forme_minime',
            "Formes maximales": 'forme_massime',
            "Total fragments": 'totale_frammenti',
            "Corps céramique": 'corpo_ceramico',
            "Revêtement": 'rivestimento',
            "Diamètre bord": 'diametro_orlo',
            "Poids": 'peso',
            "Type": 'tipo',
            "Valeur E.v.e. bord": 'eve_orlo',
            "Répertorié": 'repertato',
            "Diagnostique": 'diagnostico',
            "RA": 'n_reperto',
            "Type conteneur": 'tipo_contenitore',
            "Structure": 'struttura',
            "Année": 'years'
        }
        QUANT_ITEMS = ['Type trouvaille',
                       'Classe matériau',
                       'Définition',
                       'Corps céramique',
                       'Revêtement',
        ...
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "موقع": "sito",
            "رقم الجرد": "numero_inventario",
            "نوع القطعة": "tipo_reperto",
            "فئة المواد": "criterio_schedatura",
            "تعريف": "definizione",
            "وصف": "descrizione",
            "منطقة": "area",
            "وحدة طبقية": "us",
            ...
            "حالة الحفظ": "stato_conservazione",
            "تأريخ القطعة": "datazione_reperto",
            "أشكال دنيا": 'forme_minime',
            "أشكال قصوى": 'forme_massime',
            "إجمالي الشظايا": 'totale_frammenti',
            "جسم خزفي": 'corpo_ceramico',
            "تغليف": 'rivestimento',
            "قطر الحافة": 'diametro_orlo',
            "وزن": 'peso',
            "نوع": 'tipo',
            "قيمة E.v.e. حافة": 'eve_orlo',
            "مسجل": 'repertato',
            "تشخيصي": 'diagnostico',
            "RA": 'n_reperto',
            "نوع الحاوية": 'tipo_contenitore',
            "هيكل": 'struttura',
            "سنة": 'years'
        }
        QUANT_ITEMS = ['نوع القطعة',
                       'فئة المواد',
                       'تعريف',
                       'جسم خزفي',
                       'تغليف',
        ...
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "Jaciment": "sito",
            "Nº inventari": "numero_inventario",
            "Tipus troballa": "tipo_reperto",
            "Classe material": "criterio_schedatura",
            ...
            "Rentat": "lavato",
            "Caixa": "nr_cassa",
            "Lloc conservació": "luogo_conservazione",
            "Estat conservació": "stato_conservazione",
            "Datació troballa": "datazione_reperto",
            "Formes mínimes": 'forme_minime',
            "Formes màximes": 'forme_massime',
            "Total fragments": 'totale_frammenti',
            "Cos ceràmic": 'corpo_ceramico',
            "Revestiment": 'rivestimento',
            "Diàmetre vora": 'diametro_orlo',
            "Pes": 'peso',
            "Tipus": 'tipo',
            "Valor E.v.e. vora": 'eve_orlo',
            "Registrat": 'repertato',
            "Diagnòstic": 'diagnostico',
            "RA": 'n_reperto',
            "Tipus contenidor": 'tipo_contenitore',
            "Estructura": 'struttura',
            "Any": 'years'
        }
        QUANT_ITEMS = ['Tipus troballa',
                       'Classe material',
                       'Definició',
                       'Cos ceràmic',
                       'Revestiment',
        ...
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "Sit": "sito",
            "Nr. inventar": "numero_inventario",
            "Tip artefact": "tipo_reperto",
            "Clasă material": "criterio_schedatura",
            ...
            "Spălat": "lavato",
            "Cutie": "nr_cassa",
            "Loc conservare": "luogo_conservazione",
            "Stare conservare": "stato_conservazione",
            "Datare artefact": "datazione_reperto",
            "Forme minime": 'forme_minime',
            "Forme maxime": 'forme_massime',
            "Total fragmente": 'totale_frammenti',
            "Corp ceramic": 'corpo_ceramico',
            "Acoperire": 'rivestimento',
            "Diametru buză": 'diametro_orlo',
            "Greutate": 'peso',
            "Tip": 'tipo',
            "Valoare E.v.e. buză": 'eve_orlo',
            "Înregistrat": 'repertato',
            "Diagnostic": 'diagnostico',
            "RA": 'n_reperto',
            "Tip container": 'tipo_contenitore',
            "Structură": 'struttura',
            "An": 'years'
        }
        QUANT_ITEMS = ['Tip artefact',
                       'Clasă material',
                       'Definiție',
                       'Corp ceramic',
                       'Acoperire',
        ...
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "Sítio": "sito",
            "Nº inventário": "numero_inventario",
            "Tipo achado": "tipo_reperto",
            "Classe material": "criterio_schedatura",
            ...
            "Lavado": "lavato",
            "Caixa": "nr_cassa",
            "Local conservação": "luogo_conservazione",
            "Estado conservação": "stato_conservazione",
            "Datação achado": "datazione_reperto",
            "Formas mínimas": 'forme_minime',
            "Formas máximas": 'forme_massime',
            "Total fragmentos": 'totale_frammenti',
            "Corpo cerâmico": 'corpo_ceramico',
            "Revestimento": 'rivestimento',
            "Diâmetro bordo": 'diametro_orlo',
            "Peso": 'peso',
            "Tipo": 'tipo',
            "Valor E.v.e. bordo": 'eve_orlo',
            "Registado": 'repertato',
            "Diagnóstico": 'diagnostico',
            "RA": 'n_reperto',
            "Tipo contentor": 'tipo_contenitore',
            "Estrutura": 'struttura',
            "Ano": 'years'
        }
        QUANT_ITEMS = ['Tipo achado',
                       'Classe material',
                       'Definição',
                       'Corpo cerâmico',
                       'Revestimento',
        ...
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "Θέση": "sito",
            "Αρ. ευρετηρίου": "numero_inventario",
            "Τύπος ευρήματος": "tipo_reperto",
            "Κατηγορία υλικού": "criterio_schedatura",
            "Ορισμός": "definizione",
            ...
            "Κατάσταση διατήρησης": "stato_conservazione",
            "Χρονολόγηση ευρήματος": "datazione_reperto",
            "Ελάχ. μορφές": 'forme_minime',
            "Μέγ. μορφές": 'forme_massime',
            "Σύνολο τεμαχίων": 'totale_frammenti',
            "Κεραμικό σώμα": 'corpo_ceramico',
            "Επίστρωση": 'rivestimento',
            "Διάμετρος χείλους": 'diametro_orlo',
            "Βάρος": 'peso',
            "Τύπος": 'tipo',
            "Τιμή E.v.e. χείλους": 'eve_orlo',
            "Καταγεγραμμένο": 'repertato',
            "Διαγνωστικό": 'diagnostico',
            "RA": 'n_reperto',
            "Τύπος δοχείου": 'tipo_contenitore',
            "Κατασκευή": 'struttura',
            "Έτος": 'years'
        }
        QUANT_ITEMS = ['Τύπος ευρήματος',
                       'Κατηγορία υλικού',
                       'Ορισμός',
                       'Κεραμικό σώμα',
                       'Επίστρωση',
