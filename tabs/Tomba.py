...
class pyarchinit_Tomba(QDialog, MAIN_DIALOG_CLASS):
    ...
    if L=='it':
        ...
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "Sitio": "sito",
            "Nº ficha": "nr_scheda_taf",
            "Código estructura": "sigla_struttura",
            "Nº estructura": "nr_struttura",
            "Nº individuo": "nr_individuo",
            "Rito": "rito",
            "Descripción": "descrizione_taf",
            "Interpretación": "interpretazione_taf",
            "Señalizadores": "segnacoli",
            "Canal libatorio": "canale_libatorio_si_no",
            "Objetos externos hallados": "oggetti_rinvenuti_esterno",
            "Estado de conservación": "stato_di_conservazione",
            "Tipo de cobertura": "copertura_tipo",
            "Tipo de contenedor": "tipo_contenitore_resti",
            "Orientación eje": "orientamento_asse",
            "Orientación azimut": "orientamento_azimut",
            "Ajuar": "corredo_presenza",
            "Tipo de ajuar": "corredo_tipo",
            "Descripción ajuar": "corredo_descrizione",
            "Longitud esqueleto": "lunghezza_scheletro",
            "Posición esqueleto": "posizione_scheletro",
            "Posición cráneo": "posizione_cranio",
            "Posición miembros superiores": "posizione_arti_superiori",
            "Posición miembros inferiores": "posizione_arti_inferiori",
            "Completo": "completo_si_no",
            "Alterado": "disturbato_si_no",
            "En conexión": "in_connessione_si_no",
            "Características": "caratteristiche",
            "Período inicial": "periodo_iniziale",
            "Fase inicial": "fase_iniziale",
            "Período final": "periodo_finale",
            "Fase final": "fase_finale",
            "Datación literal": "datazione_estesa"
        }
        ...
        SORT_ITEMS = [
            ...
            "Posición esqueleto",
            "Posición cráneo",
            "Posición miembros superiores",
            "Posición miembros inferiores",
            "Completo",
            "Alterado",
            "En conexión",
            "Características",
        ...
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "Site": "sito",
            "Nº fiche": "nr_scheda_taf",
            "Code structure": "sigla_struttura",
            "Nº structure": "nr_struttura",
            "Nº individu": "nr_individuo",
            "Rite": "rito",
            "Description": "descrizione_taf",
            "Interprétation": "interpretazione_taf",
            "Marqueurs": "segnacoli",
            "Canal libatoire": "canale_libatorio_si_no",
            "Objets externes trouvés": "oggetti_rinvenuti_esterno",
            "État de conservation": "stato_di_conservazione",
            "Type de couverture": "copertura_tipo",
            "Type de contenant": "tipo_contenitore_resti",
            "Orientation axe": "orientamento_asse",
            "Orientation azimut": "orientamento_azimut",
            "Mobilier": "corredo_presenza",
            "Type de mobilier": "corredo_tipo",
            "Description mobilier": "corredo_descrizione",
            "Longueur squelette": "lunghezza_scheletro",
            "Position squelette": "posizione_scheletro",
            "Position crâne": "posizione_cranio",
            "Position membres supérieurs": "posizione_arti_superiori",
            "Position membres inférieurs": "posizione_arti_inferiori",
            "Complet": "completo_si_no",
            "Perturbé": "disturbato_si_no",
            "En connexion": "in_connessione_si_no",
            "Caractéristiques": "caratteristiche",
            "Période initiale": "periodo_iniziale",
            "Phase initiale": "fase_iniziale",
            "Période finale": "periodo_finale",
            "Phase finale": "fase_finale",
            "Datation littérale": "datazione_estesa"
        }
        ...
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "موقع": "sito",
            "رقم البطاقة": "nr_scheda_taf",
            "رمز الهيكل": "sigla_struttura",
            "رقم الهيكل": "nr_struttura",
            "رقم الفرد": "nr_individuo",
            "طقس": "rito",
            "وصف": "descrizione_taf",
            "تفسير": "interpretazione_taf",
            "علامات": "segnacoli",
            "قناة سكب": "canale_libatorio_si_no",
            "أشياء خارجية": "oggetti_rinvenuti_esterno",
            "حالة الحفظ": "stato_di_conservazione",
            "نوع الغطاء": "copertura_tipo",
            "نوع الحاوية": "tipo_contenitore_resti",
            "اتجاه المحور": "orientamento_asse",
            "اتجاه السمت": "orientamento_azimut",
            "مرفقات جنائزية": "corredo_presenza",
            "نوع المرفقات": "corredo_tipo",
            "وصف المرفقات": "corredo_descrizione",
            "طول الهيكل العظمي": "lunghezza_scheletro",
            "وضع الهيكل العظمي": "posizione_scheletro",
            "وضع الجمجمة": "posizione_cranio",
            "وضع الأطراف العلوية": "posizione_arti_superiori",
            "وضع الأطراف السفلية": "posizione_arti_inferiori",
            "كامل": "completo_si_no",
            "مضطرب": "disturbato_si_no",
            "في اتصال": "in_connessione_si_no",
            "خصائص": "caratteristiche",
            "الفترة الأولى": "periodo_iniziale",
            "المرحلة الأولى": "fase_iniziale",
            "الفترة النهائية": "periodo_finale",
            "المرحلة النهائية": "fase_finale",
            "التأريخ الحرفي": "datazione_estesa"
        }
        ...
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "Jaciment": "sito",
            "Nº fitxa": "nr_scheda_taf",
            "Codi estructura": "sigla_struttura",
            "Nº estructura": "nr_struttura",
            "Nº individu": "nr_individuo",
            "Ritu": "rito",
            "Descripció": "descrizione_taf",
            "Interpretació": "interpretazione_taf",
            "Senyalitzadors": "segnacoli",
            "Canal libatori": "canale_libatorio_si_no",
            "Objectes externs trobats": "oggetti_rinvenuti_esterno",
            "Estat de conservació": "stato_di_conservazione",
            "Tipus de cobertura": "copertura_tipo",
            "Tipus de contenidor": "tipo_contenitore_resti",
            "Orientació eix": "orientamento_asse",
            "Orientació azimut": "orientamento_azimut",
            "Aixovar": "corredo_presenza",
            "Tipus d’aixovar": "corredo_tipo",
            "Descripció aixovar": "corredo_descrizione",
            "Longitud esquelet": "lunghezza_scheletro",
            "Posició esquelet": "posizione_scheletro",
            "Posició crani": "posizione_cranio",
            "Posició extremitats superiors": "posizione_arti_superiori",
            "Posició extremitats inferiors": "posizione_arti_inferiori",
            "Complet": "completo_si_no",
            "Alterat": "disturbato_si_no",
            "En connexió": "in_connessione_si_no",
            "Característiques": "caratteristiche",
            "Període inicial": "periodo_iniziale",
            "Fase inicial": "fase_iniziale",
            "Període final": "periodo_finale",
            "Fase final": "fase_finale",
            "Datació literal": "datazione_estesa"
        }
        ...
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "Sit": "sito",
            "Nr. fișă": "nr_scheda_taf",
            "Cod structură": "sigla_struttura",
            "Nr. structură": "nr_struttura",
            "Nr. individ": "nr_individuo",
            "Rit": "rito",
            "Descriere": "descrizione_taf",
            "Interpretare": "interpretazione_taf",
            "Marcatori": "segnacoli",
            "Canal libatoriu": "canale_libatorio_si_no",
            "Obiecte externe găsite": "oggetti_rinvenuti_esterno",
            "Stare de conservare": "stato_di_conservazione",
            "Tip de acoperire": "copertura_tipo",
            "Tip de container": "tipo_contenitore_resti",
            "Orientare ax": "orientamento_asse",
            "Orientare azimut": "orientamento_azimut",
            "Inventar funerar": "corredo_presenza",
            "Tip inventar": "corredo_tipo",
            "Descriere inventar": "corredo_descrizione",
            "Lungime schelet": "lunghezza_scheletro",
            "Poziție schelet": "posizione_scheletro",
            "Poziție craniu": "posizione_cranio",
            "Poziție membre superioare": "posizione_arti_superiori",
            "Poziție membre inferioare": "posizione_arti_inferiori",
            "Complet": "completo_si_no",
            "Deranjat": "disturbato_si_no",
            "În conexiune": "in_connessione_si_no",
            ...
            "Datare literală": "datazione_estesa"
        }
        ...
        SORT_ITEMS = [
            ...
            "Poziție schelet",
            "Poziție craniu",
            "Poziție membre superioare",
            "Poziție membre inferioare",
            "Complet",
            "Deranjat",
            "În conexiune",
            "Caracteristici",
        ...
        CONVERSION_DICT = {
            ...
            "Nº estrutura": "nr_struttura",
            "Nº indivíduo": "nr_individuo",
            "Rito": "rito",
            "Descrição": "descrizione_taf",
            "Interpretação": "interpretazione_taf",
            "Sinalizadores": "segnacoli",
            "Canal libatório": "canale_libatorio_si_no",
            "Objetos externos encontrados": "oggetti_rinvenuti_esterno",
            "Estado de conservação": "stato_di_conservazione",
            "Tipo de cobertura": "copertura_tipo",
            "Tipo de contentor": "tipo_contenitore_resti",
            "Orientação eixo": "orientamento_asse",
            "Orientação azimute": "orientamento_azimut",
            "Espólio": "corredo_presenza",
            "Tipo de espólio": "corredo_tipo",
            "Descrição espólio": "corredo_descrizione",
            "Comprimento esqueleto": "lunghezza_scheletro",
            "Posição esqueleto": "posizione_scheletro",
            "Posição crânio": "posizione_cranio",
            "Posição membros superiores": "posizione_arti_superiori",
            "Posição membros inferiores": "posizione_arti_inferiori",
            "Completo": "completo_si_no",
            "Perturbado": "disturbato_si_no",
            "Em conexão": "in_connessione_si_no",
            "Características": "caratteristiche",
            "Período inicial": "periodo_iniziale",
            "Fase inicial": "fase_iniziale",
            "Período final": "periodo_finale",
            "Fase final": "fase_finale",
            "Datação literal": "datazione_estesa"
        }
        ...
        SORT_ITEMS = [
            ...
            "Tipo de espólio",
            "Descrição espólio",
            "Comprimento esqueleto",
            "Posição esqueleto",
            "Posição crânio",
            "Posição membros superiores",
            "Posição membros inferiores",
            "Completo",
            "Perturbado",
            "Em conexão",
            "Características",
        ...
        CONVERSION_DICT = {
            ID_TABLE: ID_TABLE,
            "Θέση": "sito",
            "Αρ. δελτίου": "nr_scheda_taf",
            "Κωδικός κατασκευής": "sigla_struttura",
            "Αρ. κατασκευής": "nr_struttura",
            "Αρ. ατόμου": "nr_individuo",
            "Τελετουργία": "rito",
            "Περιγραφή": "descrizione_taf",
            "Ερμηνεία": "interpretazione_taf",
            "Δείκτες": "segnacoli",
            "Κανάλι σπονδής": "canale_libatorio_si_no",
            "Εξωτερικά αντικείμενα": "oggetti_rinvenuti_esterno",
            "Κατάσταση διατήρησης": "stato_di_conservazione",
            "Τύπος κάλυψης": "copertura_tipo",
            "Τύπος δοχείου": "tipo_contenitore_resti",
            "Προσανατολισμός άξονα": "orientamento_asse",
            "Προσανατολισμός αζιμούθιου": "orientamento_azimut",
            "Κτερίσματα": "corredo_presenza",
            "Τύπος κτερισμάτων": "corredo_tipo",
            "Περιγραφή κτερισμάτων": "corredo_descrizione",
            "Μήκος σκελετού": "lunghezza_scheletro",
            "Θέση σκελετού": "posizione_scheletro",
            "Θέση κρανίου": "posizione_cranio",
            "Θέση άνω άκρων": "posizione_arti_superiori",
            "Θέση κάτω άκρων": "posizione_arti_inferiori",
            "Πλήρες": "completo_si_no",
            "Διαταραγμένο": "disturbato_si_no",
            "Σε σύνδεση": "in_connessione_si_no",
            "Χαρακτηριστικά": "caratteristiche",
            "Αρχική περίοδος": "periodo_iniziale",
            "Αρχική φάση": "fase_iniziale",
            "Τελική περίοδος": "periodo_finale",
            "Τελική φάση": "fase_finale",
            "Κυριολεκτική χρονολόγηση": "datazione_estesa"
        }
        ...
        SORT_ITEMS = [
            ...
            "Προσανατολισμός αζιμούθιου",
            "Κτερίσματα",
            "Τύπος κτερισμάτων",
            "Περιγραφή κτερισμάτων",
            "Μήκος σκελετού",
            "Θέση σκελετού",
            "Θέση κρανίου",
            "Θέση άνω άκρων",
    ...
    def on_pushButton_print_pressed(self):
        if self.L=='it':
            ...
            if self.checkBox_s_us.isChecked():
                US_pdf_sheet = generate_tomba_pdf()
                data_list = self.generate_list_pdf()
                US_pdf_sheet.build_Tomba_sheets_de(data_list)
                QMessageBox.warning(self, 'Ok', "Export beendet Taphonomie-Formular", QMessageBox.StandardButton.Ok)
            else:
                pass
            ...
            if self.checkBox_s_us.isChecked():
                US_pdf_sheet = generate_tomba_pdf()
                data_list = self.generate_list_pdf()
                US_pdf_sheet.build_Tomba_sheets_fr(data_list)
                QMessageBox.warning(self, 'Ok', "Exportation terminée Fiche Taphonomie", QMessageBox.StandardButton.Ok)
            else:
                pass
            ...
            if self.checkBox_s_us.isChecked():
                US_pdf_sheet = generate_tomba_pdf()
                data_list = self.generate_list_pdf()
                US_pdf_sheet.build_Tomba_sheets_es(data_list)
                QMessageBox.warning(self, 'Ok', "Exportación completada Ficha Tafonomía", QMessageBox.StandardButton.Ok)
            else:
                pass
            ...
            if self.checkBox_s_us.isChecked():
                US_pdf_sheet = generate_tomba_pdf()
                data_list = self.generate_list_pdf()
                US_pdf_sheet.build_Tomba_sheets_ar(data_list)
                QMessageBox.warning(self, 'Ok', "اكتمل تصدير بطاقة التافونومية", QMessageBox.StandardButton.Ok)
            else:
                pass
            ...
            if self.checkBox_s_us.isChecked():
                US_pdf_sheet = generate_tomba_pdf()
                data_list = self.generate_list_pdf()
                US_pdf_sheet.build_Tomba_sheets_ca(data_list)
                QMessageBox.warning(self, 'Ok', "Exportació completada Fitxa Tafonomia", QMessageBox.StandardButton.Ok)
            else:
                pass
            ...
            if self.checkBox_s_us.isChecked():
                US_pdf_sheet = generate_tomba_pdf()
                data_list = self.generate_list_pdf()
                US_pdf_sheet.build_Tomba_sheets_en(data_list)
                QMessageBox.warning(self, 'Ok', "Export finished Taphonomy Form", QMessageBox.StandardButton.Ok)
            else:
                pass
