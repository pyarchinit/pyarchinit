...
class pyarchinit_Thesaurus(QDialog, MAIN_DIALOG_CLASS):
    ...
    def charge_list(self):
        ...
        # Multilingual table mapping: {lang: {display_name: table_name}}
        TABLE_DISPLAY_MAPPING_I18N = {
            'it': {
                'Sito': 'site_table',
                'US': 'us_table',
                'UT': 'ut_table',
                ...
                'Ceramica': 'pottery_table',
                'Personale Cantiere': 'cantiere_personale_table',
                'Presenze Cantiere': 'cantiere_presenze_table',
                'Attrezzature Cantiere': 'cantiere_attrezzature_table',
                'Budget Cantiere': 'cantiere_budget_table',
            },
            'en': {
                'Site': 'site_table',
                'SU': 'us_table',
                'TU': 'ut_table',
                'Fauna': 'fauna_table',
                'Finds Inventory': 'inventario_materiali_table',
                'Samples': 'campioni_table',
                'Stone Inventory': 'inventario_lapidei_table',
                'Structure': 'struttura_table',
                'Burial': 'tomba_table',
                'Individuals': 'individui_table',
                'Documentation': 'documentazione_table',
                'TMA Archaeological Materials': 'tma_materiali_archeologici',
                'TMA Repeatable Materials': 'tma_materiali_ripetibili',
                'Pottery': 'pottery_table',
                'Site Personnel': 'cantiere_personale_table',
                'Site Attendance': 'cantiere_presenze_table',
                'Site Equipment': 'cantiere_attrezzature_table',
                'Site Budget': 'cantiere_budget_table',
            },
            'de': {
                'Fundstelle': 'site_table',
                'SE': 'us_table',
                'TE': 'ut_table',
                'Fauna': 'fauna_table',
                'Fundinventar': 'inventario_materiali_table',
                'Proben': 'campioni_table',
                'Steininventar': 'inventario_lapidei_table',
                'Struktur': 'struttura_table',
                'Grab': 'tomba_table',
                'Individuen': 'individui_table',
                'Dokumentation': 'documentazione_table',
                'TMA Archäologische Materialien': 'tma_materiali_archeologici',
                'TMA Wiederholbare Materialien': 'tma_materiali_ripetibili',
                'Keramik': 'pottery_table',
                'Grabungspersonal': 'cantiere_personale_table',
                'Anwesenheit': 'cantiere_presenze_table',
                'Ausrüstung': 'cantiere_attrezzature_table',
                'Budget': 'cantiere_budget_table',
            },
            'es': {
                'Sitio': 'site_table',
                'UE': 'us_table',
                'UT': 'ut_table',
                'Fauna': 'fauna_table',
                'Inventario de Materiales': 'inventario_materiali_table',
                'Muestras': 'campioni_table',
                'Inventario de Piedras': 'inventario_lapidei_table',
                'Estructura': 'struttura_table',
                'Tumba': 'tomba_table',
                'Individuos': 'individui_table',
                'Documentación': 'documentazione_table',
                'TMA Materiales Arqueológicos': 'tma_materiali_archeologici',
                'TMA Materiales Repetibles': 'tma_materiali_ripetibili',
                'Cerámica': 'pottery_table',
                'Personal de Obra': 'cantiere_personale_table',
            ...
            'fr': {
                ...
                'UT': 'ut_table',
                'Faune': 'fauna_table',
                'Inventaire du Mobilier': 'inventario_materiali_table',
                'Échantillons': 'campioni_table',
                'Inventaire Lapidaire': 'inventario_lapidei_table',
                'Structure': 'struttura_table',
                'Sépulture': 'tomba_table',
                'Individus': 'individui_table',
                'Documentation': 'documentazione_table',
                'TMA Matériaux Archéologiques': 'tma_materiali_archeologici',
                'TMA Matériaux Répétables': 'tma_materiali_ripetibili',
                'Céramique': 'pottery_table',
                'Personnel de Chantier': 'cantiere_personale_table',
                'Présences': 'cantiere_presenze_table',
                'Équipement': 'cantiere_attrezzature_table',
                'Budget': 'cantiere_budget_table',
            },
            'ar': {
                'الموقع': 'site_table',
                'وحدة طبقية': 'us_table',
                'وحدة طوبوغرافية': 'ut_table',
                'حيوانات': 'fauna_table',
                'جرد المواد': 'inventario_materiali_table',
                'عينات': 'campioni_table',
                'جرد الأحجار': 'inventario_lapidei_table',
                'هيكل': 'struttura_table',
                'قبر': 'tomba_table',
                'أفراد': 'individui_table',
                'توثيق': 'documentazione_table',
                'TMA مواد أثرية': 'tma_materiali_archeologici',
                'TMA مواد قابلة للتكرار': 'tma_materiali_ripetibili',
                'فخار': 'pottery_table',
                'موظفو الموقع': 'cantiere_personale_table',
                'الحضور': 'cantiere_presenze_table',
                'المعدات': 'cantiere_attrezzature_table',
                'الميزانية': 'cantiere_budget_table',
            },
            'ca': {
                'Lloc': 'site_table',
                'UE': 'us_table',
                'UT': 'ut_table',
                'Fauna': 'fauna_table',
                'Inventari de Materials': 'inventario_materiali_table',
                'Mostres': 'campioni_table',
                'Inventari Lapidi': 'inventario_lapidei_table',
                'Estructura': 'struttura_table',
                'Tomba': 'tomba_table',
                'Individus': 'individui_table',
                'Documentació': 'documentazione_table',
                'TMA Materials Arqueològics': 'tma_materiali_archeologici',
                'TMA Materials Repetibles': 'tma_materiali_ripetibili',
                'Ceràmica': 'pottery_table',
                "Personal d'Obra": 'cantiere_personale_table',
                'Assistència': 'cantiere_presenze_table',
                'Equipament': 'cantiere_attrezzature_table',
                'Pressupost': 'cantiere_budget_table',
            },
            'ro': {
                'Sit': 'site_table',
                'US': 'us_table',
                'UT': 'ut_table',
                'Fauna': 'fauna_table',
                'Inventar Materiale': 'inventario_materiali_table',
                'Eșantioane': 'campioni_table',
                'Inventar Piatra': 'inventario_lapidei_table',
                'Structură': 'struttura_table',
                'Mormânt': 'tomba_table',
                'Indivizi': 'individui_table',
                'Documentație': 'documentazione_table',
                'TMA Materiale Arheologice': 'tma_materiali_archeologici',
                'TMA Materiale Repetabile': 'tma_materiali_ripetibili',
                'Ceramică': 'pottery_table',
                'Personal Șantier': 'cantiere_personale_table',
                'Prezențe': 'cantiere_presenze_table',
                'Echipamente': 'cantiere_attrezzature_table',
                'Buget': 'cantiere_budget_table',
            },
            'pt': {
                'Sítio': 'site_table',
                'UE': 'us_table',
                'UT': 'ut_table',
                'Fauna': 'fauna_table',
                'Inventário de Materiais': 'inventario_materiali_table',
                'Amostras': 'campioni_table',
                'Inventário de Pedras': 'inventario_lapidei_table',
                'Estrutura': 'struttura_table',
                'Sepultura': 'tomba_table',
                'Indivíduos': 'individui_table',
                'Documentação': 'documentazione_table',
                'TMA Materiais Arqueológicos': 'tma_materiali_archeologici',
                'TMA Materiais Repetíveis': 'tma_materiali_ripetibili',
                'Cerâmica': 'pottery_table',
                'Pessoal de Obra': 'cantiere_personale_table',
                'Presenças': 'cantiere_presenze_table',
                'Equipamento': 'cantiere_attrezzature_table',
                'Orçamento': 'cantiere_budget_table',
            },
            'el': {
                'Τοποθεσία': 'site_table',
                'ΣΕ': 'us_table',
                'ΤΜ': 'ut_table',
                'Πανίδα': 'fauna_table',
                'Κατάλογος Υλικών': 'inventario_materiali_table',
                'Δείγματα': 'campioni_table',
                'Κατάλογος Λίθων': 'inventario_lapidei_table',
                'Δομή': 'struttura_table',
                'Τάφος': 'tomba_table',
                'Άτομα': 'individui_table',
                'Τεκμηρίωση': 'documentazione_table',
                'TMA Αρχαιολογικά Υλικά': 'tma_materiali_archeologici',
                'TMA Επαναλαμβανόμενα Υλικά': 'tma_materiali_ripetibili',
                'Κεραμική': 'pottery_table',
                'Προσωπικό Ανασκαφής': 'cantiere_personale_table',
                'Παρουσίες': 'cantiere_presenze_table',
                'Εξοπλισμός': 'cantiere_attrezzature_table',
                'Προϋπολογισμός': 'cantiere_budget_table',
            },
        }

        # Select mapping based on current language, fallback to English then Italian
        self.TABLE_DISPLAY_MAPPING = TABLE_DISPLAY_MAPPING_I18N.get(
            self.L, TABLE_DISPLAY_MAPPING_I18N.get('en', TABLE_DISPLAY_MAPPING_I18N['it']))
    ...
    def charge_n_sigla(self):    
        ...
        code_descriptions = {
            ...
            'cantiere_personale_table': {
                '14.1': {'it': 'Ruolo', 'en': 'Role', 'de': 'Rolle', 'es': 'Rol', 'fr': 'Rôle', 'ar': 'الدور', 'ca': 'Rol', 'ro': 'Rol', 'pt': 'Função', 'el': 'Ρόλος'},
                '14.2': {'it': 'Tipo Contratto', 'en': 'Contract Type', 'de': 'Vertragstyp', 'es': 'Tipo de Contrato', 'fr': 'Type de Contrat', 'ar': 'نوع العقد', 'ca': 'Tipus de Contracte', 'ro': 'Tip Contract', 'pt': 'Tipo de Contrato', 'el': 'Τύπος Σύμβασης'}
            },
            'cantiere_presenze_table': {
                '14.3': {'it': 'Tipo Giornata', 'en': 'Day Type', 'de': 'Tagestyp', 'es': 'Tipo de Jornada', 'fr': 'Type de Journée', 'ar': 'نوع اليوم', 'ca': 'Tipus de Jornada', 'ro': 'Tip Zi', 'pt': 'Tipo de Dia', 'el': 'Τύπος Ημέρας'}
            },
            'cantiere_attrezzature_table': {
                '14.4': {'it': 'Categoria', 'en': 'Category', 'de': 'Kategorie', 'es': 'Categoría', 'fr': 'Catégorie', 'ar': 'الفئة', 'ca': 'Categoria', 'ro': 'Categorie', 'pt': 'Categoria', 'el': 'Κατηγορία'},
                '14.5': {'it': 'Stato', 'en': 'Status', 'de': 'Status', 'es': 'Estado', 'fr': 'État', 'ar': 'الحالة', 'ca': 'Estat', 'ro': 'Stare', 'pt': 'Estado', 'el': 'Κατάσταση'},
                '14.6': {'it': 'Proprietà', 'en': 'Ownership', 'de': 'Eigentum', 'es': 'Propiedad', 'fr': 'Propriété', 'ar': 'الملكية', 'ca': 'Propietat', 'ro': 'Proprietate', 'pt': 'Propriedade', 'el': 'Ιδιοκτησία'}
            },
            'cantiere_budget_table': {
                '14.7': {'it': 'Categoria', 'en': 'Category', 'de': 'Kategorie', 'es': 'Categoría', 'fr': 'Catégorie', 'ar': 'الفئة', 'ca': 'Categoria', 'ro': 'Categorie', 'pt': 'Categoria', 'el': 'Κατηγορία'}
            }
        }
