...
from  pyarchinit_thesaurus_ui import Ui_DialogThesaurus
...
##		self.comboBox_sito.addItems(sito_vl)
	...
	def on_pushButton_search_go_pressed(self):
		if self.BROWSE_STATUS != "f":
			...
			self.TABLE_FIELDS[4] : "'"+str(self.comboBox_tipologia_sigla.currentText())+"'"		#3 - tipologia sigla
			}
...
##			erp.export_rel_pdf()
	...
	def fill_fields(self, n=0):
		...
		str(self.comboBox_tipologia_sigla.setEditText(self.DATA_LIST[self.rec_num].tipologia_sigla))		#3 - tipologia sigla
		str(self.comboBox_nome_tabella.setEditText(self.DATA_LIST[self.rec_num].nome_tabella))		#4 - nome tabella
		str(str(self.textEdit_descrizione_sigla.setText(self.DATA_LIST[self.rec_num].descrizione)))	#5 - descrizione sigla
