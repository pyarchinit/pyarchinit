-- Performance indexes for pyArchInit PostgreSQL database
...
ANALYZE us_table;
ANALYZE inventario_materiali_table;
ANALYZE site_table;
ANALYZE pyarchinit_thesaurus_sigle;
ANALYZE pyarchinit_quote;
ANALYZE pyarchinit_reperti;
ANALYZE tomba_table;
ANALYZE periodizzazione_table;
ANALYZE struttura_table;
ANALYZE documentazione_table;
ANALYZE campioni_table;
