...
class pyarchinit_Deteta(QDialog, Ui_Dialog_eta):
	...
	def on_pushButton_connect_pressed(self):
		...
		try:
			...
			if bool(self.DATA_LIST) == True:
				...
				QMessageBox.warning(self, "BENVENUTO", "Benvenuto in pyArchInit" + self.NOME_SCHEDA + ". Il database è vuoto. Premi 'Ok' e buon lavoro!",  QMessageBox.Ok)
			...
			if e.find("no such table"):
				QMessageBox.warning(self, "Alert", "La connessione è fallita <br><br> Tabella non presente. E' NECESSARIO RIAVVIARE QGIS" + e ,  QMessageBox.Ok)
			else:
				QMessageBox.warning(self, "Alert", "La connessione è fallita <br> Errore: <br>" + str(e) ,  QMessageBox.Ok)
	...
	def set_LIST_REC_CORR(self):
		...
		for i in self.TABLE_FIELDS:
			self.DATA_LIST_REC_CORR.append(ast.literal_eval("str(self.DATA_LIST[self.REC_CORR]." + i + ")"))
