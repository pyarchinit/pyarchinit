...
class PyArchInitPlugin(object):
    ...
    def initGui(self):
        ...
        icon_paius = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'pai_us.png'))
        ...
        # add Actions data
        icon_site = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'iconSite.png'))
        ...
        icon_US = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'iconSus.png'))
        ...
        icon_Finds = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'iconFinds.png'))
        ...
        icon_camp_exp = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'champion.png'))
        ...
        icon_Lapidei = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'iconAlma.png'))
        ...
        icon_per = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'iconPer.png'))
        ...
        icon_Struttura = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'iconStrutt.png'))
        ...
        icon_Schedaind = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'iconIND.png'))
        ...
        icon_Tafonomia = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'iconGrave.png'))
        ...
        if self.PARAMS_DICT['EXPERIMENTAL'] == 'Si':
            icon_Detsesso = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'iconSesso.png'))
            ...
            icon_Deteta = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'iconEta.png'))
        ...
        if self.PARAMS_DICT['EXPERIMENTAL'] == 'Si':
            ...
            icon_UT = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'iconUT.png'))
        ...
        icon_documentazione = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'icondoc.png'))
        ...
        if self.PARAMS_DICT['EXPERIMENTAL'] == 'Si':
            icon_imageViewer = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'photo.png'))
            ...
            icon_Directory_export = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'directoryExp.png'))
            ...
            icon_pdf_exp = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'pdf-icon.png'))
        ...
        if self.PARAMS_DICT['EXPERIMENTAL'] == 'Si':
            ...
            icon_Archeozoology = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'iconMegacero.png'))
            ...
            icon_GisTimeController = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'iconTimeControll.png'))
            ...
            icon_Comparision = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'comparision.png'))
        ...
        icon_thesaurus = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'thesaurusicon.png'))
        ...
        icon_Con = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'iconConn.png'))
        ...
        icon_Dbmanagment = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'backup.png'))
        ...
        icon_Info = '{}{}'.format(filepath, os.path.join(os.sep, 'modules', 'ui', 'images', 'iconInfo.png'))
