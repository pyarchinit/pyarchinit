...
CREATE TABLE public.pyarchinit_campionature (
    ...
    the_geom public.geometry(Point,0)
);
...
CREATE TABLE public.pyarchinit_linee_rif (
    ...
    the_geom public.geometry(LineString,0),
...
CREATE TABLE public.us_table (
    ...
    attivita character varying(100),
    anno_scavo character varying(255),
    metodo_di_scavo character varying(255),
    inclusi text,
    campioni text,
    rapporti text,
    data_schedatura character varying(255),
    schedatore character varying(255),
    formazione character varying(255),
    stato_di_conservazione character varying(255),
    colore character varying(255),
    consistenza character varying(255),
    struttura character varying(255),
    ...
    tipologia_opera text DEFAULT ''::text,
    sezione_muraria text DEFAULT ''::text,
    superficie_analizzata text DEFAULT ''::text,
    orientamento text DEFAULT ''::text,
    materiali_lat text DEFAULT ''::text,
    lavorazione_lat text DEFAULT ''::text,
    consistenza_lat text DEFAULT ''::text,
    forma_lat text DEFAULT ''::text,
    colore_lat text DEFAULT ''::text,
    impasto_lat text DEFAULT ''::text,
    forma_p text DEFAULT ''::text,
    colore_p text DEFAULT ''::text,
    taglio_p text DEFAULT ''::text,
    posa_opera_p text DEFAULT ''::text,
    inerti_usm text DEFAULT ''::text,
    tipo_legante_usm text DEFAULT ''::text,
    rifinitura_usm text DEFAULT ''::text,
...
CREATE TABLE public.pyarchinit_ripartizioni_spaziali (
    ...
    sito_rs text,
    the_geom public.geometry(Polygon,0),
...
CREATE TABLE public.pyunitastratigrafiche (
	...
	coord text,
	the_geom public.geometry(MultiPolygon,0),
...
-- TABLE REMOVED - pyuscaratterizzazioni is no longer used
--
...
--
-- Name: tma_materiali_ripetibili; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.tma_materiali_ripetibili (
    id SERIAL PRIMARY KEY,
    -- Foreign key to main TMA record
    id_tma BIGINT NOT NULL,
...
-- Note: Views are created separately after SRID update to avoid conflicts
...
(
  gid BIGINT NOT NULL,
  the_geom geometry(LineString,0),
  id_doc BIGINT,
  sito character varying(200),
...
-- CONSTRAINT REMOVED - pyuscaratterizzazioni table removed
--
...
--
-- Name: fk_tma_materiali_ripetibili_tma; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tma_materiali_ripetibili
    ADD CONSTRAINT fk_tma_materiali_ripetibili_tma
        FOREIGN KEY (id_tma)
        REFERENCES public.tma_materiali_archeologici(id)
        ON DELETE CASCADE;
