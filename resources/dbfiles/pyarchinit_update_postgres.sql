...
--    OWNER TO postgres;
CREATE TABLE IF NOT EXISTS public.pottery_table (
...
CREATE SEQUENCE IF NOT EXISTS public.pottery_table_id_rep_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.inventario_materiali_table ADD COLUMN IF NOT EXISTS photo_id TEXT;
ALTER TABLE public.inventario_materiali_table ADD COLUMN IF NOT EXISTS drawing_id TEXT;
