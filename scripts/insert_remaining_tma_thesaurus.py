...
# -*- coding: utf-8 -*-
"""
Script per inserire i rimanenti valori del thesaurus TMA
(tutti tranne località, area e settore che sono già gestiti con gerarchia)
"""
...
# Definizione dei valori del thesaurus TMA (esclusi 10.18, 10.7, 10.19)
THESAURUS_DATA = {
...
def main():
    ...
    try:
        ...
        print("\nInserimento rimanenti valori thesaurus TMA...")
        print("=" * 50)
