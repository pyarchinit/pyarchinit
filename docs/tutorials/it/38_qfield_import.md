...
Barra menu **pyArchInit → Importa da QField (GPKG)**.

Si apre il dialog *Importa da QField*: QGIS **non si blocca** durante
l'operazione perché la copia delle foto e l'accesso a WebDAV girano in un thread
separato.
