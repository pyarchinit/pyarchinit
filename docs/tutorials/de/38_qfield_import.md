...
Menüleiste **pyArchInit → Import aus QField (GPKG)**.

Der Dialog *Import aus QField* öffnet sich: QGIS **friert nicht ein**, da das
Kopieren der Fotos und der WebDAV-Zugriff in einem separaten Thread laufen.
