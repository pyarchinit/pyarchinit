...
<qgis version="2.2.0-Valmiera" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule filter="(stratigraph_index_us = 1) AND (tipo_us_s = 'carbone')" symbol="0" label="Carbone"/>
      <rule filter="(stratigraph_index_us = 1) AND (tipo_us_s = 'sabbia')" symbol="1" label="Sabbie"/>
      <rule filter="(stratigraph_index_us = 1) AND (tipo_us_s = 'pietra')" symbol="2" label="Pietra"/>
      <rule filter="(stratigraph_index_us = 1) AND (tipo_us_s = 'struttura focolare')" symbol="3" label="Stuttura di focolare"/>
      <rule filter="(stratigraph_index_us = 1) AND (tipo_us_s = 'struttura combustione')" symbol="4" label="Struttura di combustione"/>
      <rule filter="(stratigraph_index_us = 1) AND (tipo_us_s = 'argilla')" symbol="5" label="Strato di Terra"/>
      <rule filter="(stratigraph_index_us = 1) AND (tipo_us_s = 'selce')" symbol="6" label="Selce"/>
    </rules>
    <symbols>
