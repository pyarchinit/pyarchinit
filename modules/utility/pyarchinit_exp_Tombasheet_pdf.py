...
class Tomba_index_pdf_sheet(object):
    ...
    def getTable(self):
        ...
        materiali = ''
        if self.materiali and eval(self.materiali):
            for i in (eval(self.materiali) if self.materiali else []):  # gigi
                if materiali == '':
                    try:
    ...
    def getTable_en(self):
        ...
        num_scheda = Paragraph("<b>N° Form</b><br/>" + str(self.nr_scheda_taf), styNormal)
    ...
    def getTable_de(self):
        ...
        numero_individuo = Paragraph("<b>N° Individuell</b><br/>" + str(self.nr_individuo), styNormal)
