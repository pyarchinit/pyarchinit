...
#from modules.db.structures_metadata.Pottery_table import *
from ..db.structures_metadata.Pottery_table import PotteryTable
...
# pysito_point(metadata)
# pysito_polygon(metadata)
# pyquote(metadata)
# pyquote_usm(metadata)
# pyus_negative(metadata)
# pystrutture(metadata)
pyreperti.define_table(metadata)
# pyindividui(metadata)
# pycampioni(metadata)
# pytomba(metadata)
# pydocumentazione(metadata)
# pylineeriferimento(metadata)
# pyripartizioni_spaziali(metadata)
# pysezioni(metadata)
...
# Dopo aver definito tutte le tabelle con `metadata` condiviso:
metadata.create_all(engine)
