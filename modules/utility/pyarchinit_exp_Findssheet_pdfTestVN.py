...
from reportlab.platypus import Table, PageBreak, SimpleDocTemplate, Spacer, Image
...
class single_Finds_pdf_sheet:
    ...
    def create_sheet(self):
        ...
        # 0 row
        intestazione = Paragraph("<b>SCHEDA INVENTARIO REPERTI - " + str(self.datestrfdate()) + "</b>", styNormal)
        ...
        test_image = Image("C:\\Users\\Windows\\diegni_ceramica\\inv1.png")

        ##		if test_image.drawWidth < 800:

        test_image.drawHeight = 1.5 * inch * test_image.drawHeight / test_image.drawWidth
        test_image.drawWidth = 1.5 * inch

        ##x : 0.5*inch = height : width

        # f = open("C:\\Users\\Windows\\diegni_ceramica\\test_inc.txt", "w")
        # f.write(str(inch))
        # f.close()
        ##		else:
        ##			test_image.drawHeight = 5*inch*test_image.drawHeight / test_image.drawWidth
        ##			test_image.drawWidth = 5*inch

        # Himmagine : Hfissa = Limmagine :

        ##		fixedHeight = 200
        ##		xWidth_image = (200 * test_image.drawWidth) / test_image.drawHeight
        ##
        ##		im = IM.open("C:\\Users\\Windows\\diegni_ceramica\\inv1.png")
        ##		im.resize((int(xWidth_image),fixedHeight))
        ##		im.save("C:\\Users\\Windows\\diegni_ceramica\\inv1b.png")
        ...
        table_style = [
            ...
            ('SPAN', (0, 10), (9, 10))  # Rimmagine
            # 13 row
            # ('SPAN', (0,11),(9,11))  #pie' di pagina
            # ('ALIGN',(0,11), (9,11),'CENTER')
        ]
