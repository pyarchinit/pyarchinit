    ...
    try:
        ...
        if 'sqlite' in conn_str.lower():
            try:
                ...
                columns = [col['name'] for col in inspector.get_columns('pyarchinit_siti_polygonal')]
                ...
                if 'the_geom' not in columns:
                    ...
                    with engine.connect() as conn:
                        ...
                        # Add geometry column
                        conn.execute("SELECT AddGeometryColumn('pyarchinit_siti_polygonal', 'the_geom', -1, 'POLYGON', 'XY')")
