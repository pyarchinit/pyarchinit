...
class pyunitastratigrafiche_usm:
    ...
    pyunitastratigrafiche_usm = Table('pyunitastratigrafiche_usm', metadata,
    ...
    try:
        ...
        if 'sqlite' in conn_str.lower():
            try:
                ...
                columns = [col['name'] for col in inspector.get_columns('pyunitastratigrafiche_usm')]
                ...
                if 'the_geom' not in columns:
                    ...
                    with engine.connect() as conn:
                        ...
                        # Add geometry column
                        conn.execute("SELECT AddGeometryColumn('pyunitastratigrafiche_usm', 'the_geom', -1, 'MULTIPOLYGON', 'XY')")
