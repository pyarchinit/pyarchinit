...
from modules.db.pyarchinit_db_mapper import US, UT, SITE, PERIODIZZAZIONE, POTTERY, TMA, TMA_MATERIALI, \
    ...
    PERSONALE, PRESENZE, ATTREZZATURE, BUDGET, COMPUTO_METRICO, ARCHEOZOOLOGY
...
class Pyarchinit_db_management(object):
    ...
    def query_bool(self, params, table_class_name):
        ...
        table_classes = {
            ...
            'BUDGET': BUDGET, 'COMPUTO_METRICO': COMPUTO_METRICO, 'ARCHEOZOOLOGY': ARCHEOZOOLOGY
    ...
    def delete_one_record(self, tn, id_col, id_rec):
        ...
        # Ensure id_rec is an integer for proper comparison
        self.id_rec = int(id_rec) if id_rec is not None else id_rec

        # SQLAlchemy 2.0: use fresh metadata for reflection
        metadata = MetaData()
