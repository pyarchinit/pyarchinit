...
class pyarchinit_Site(QDialog, Ui_DialogSite):
	...
	def on_pushButton_search_go_pressed(self):
		if self.BROWSE_STATUS != "f":
			...
			'definizione_sito': "'" + str(self.comboBox_definizione_sito.currentText())+"'"		#67- definizione_sito
			}
...
##		unicode(self.comboBox_provincia.currentText())]                     	#6 - Provincia
	...
	def on_pushButton_genera_us_pressed(self):
		self.DB_MANAGER.insert_arbitrary_number_of_us_records(int(self.lineEdit_us_range.text()), str(self.comboBox_sito.currentText()), int(self.lineEdit_area.text()),int( self.lineEdit_n_us.text()))
	...
	def fill_fields(self, n=0):
		...
		str(self.comboBox_definizione_sito.setEditText(self.DATA_LIST[self.rec_num].definizione_sito))#7 - definizione_sito
